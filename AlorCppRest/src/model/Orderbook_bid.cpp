...
#include "AlorCppRest/model/Orderbook_bid.h"
...
void Orderbook_bid::validate()
{
    // TODO: implement validation
}

web::json::value Orderbook_bid::toJson() const
{
...
bool Orderbook_bid::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Orderbook_bid::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Orderbook_bid::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
double Orderbook_bid::getPrice() const
{
    return m_Price;
}

void Orderbook_bid::setPrice(double value)
{
    m_Price = value;
    m_PriceIsSet = true;
}

bool Orderbook_bid::priceIsSet() const
{
    return m_PriceIsSet;
}

void Orderbook_bid::unsetPrice()
{
    m_PriceIsSet = false;
}
int32_t Orderbook_bid::getVolume() const
{
    return m_Volume;
}

void Orderbook_bid::setVolume(int32_t value)
{
    m_Volume = value;
    m_VolumeIsSet = true;
}

bool Orderbook_bid::volumeIsSet() const
{
    return m_VolumeIsSet;
}

void Orderbook_bid::unsetVolume()
{
    m_VolumeIsSet = false;
}
}
