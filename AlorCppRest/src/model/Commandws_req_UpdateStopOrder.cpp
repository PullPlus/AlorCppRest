...
Commandws_req_UpdateStopOrder::Commandws_req_UpdateStopOrder()
{
...
void Commandws_req_UpdateStopOrder::validate()
{
    // TODO: implement validation
}

web::json::value Commandws_req_UpdateStopOrder::toJson() const
{
...
bool Commandws_req_UpdateStopOrder::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Commandws_req_UpdateStopOrder::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Commandws_req_UpdateStopOrder::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Commandws_req_UpdateStopOrder::getOpcode() const
{
    return m_Opcode;
}

void Commandws_req_UpdateStopOrder::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Commandws_req_UpdateStopOrder::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Commandws_req_UpdateStopOrder::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Commandws_req_UpdateStopOrder::getGuid() const
{
    return m_Guid;
}

void Commandws_req_UpdateStopOrder::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Commandws_req_UpdateStopOrder::guidIsSet() const
{
    return m_GuidIsSet;
}

void Commandws_req_UpdateStopOrder::unsetGuid()
{
    m_GuidIsSet = false;
}
int64_t Commandws_req_UpdateStopOrder::getOrderId() const
{
    return m_OrderId;
}

void Commandws_req_UpdateStopOrder::setOrderId(int64_t value)
{
    m_OrderId = value;
    m_OrderIdIsSet = true;
}

bool Commandws_req_UpdateStopOrder::orderIdIsSet() const
{
    return m_OrderIdIsSet;
}

void Commandws_req_UpdateStopOrder::unsetOrderId()
{
    m_OrderIdIsSet = false;
}
std::shared_ptr<Side> Commandws_req_UpdateStopOrder::getSide() const
{
    return m_Side;
}

void Commandws_req_UpdateStopOrder::setSide(const std::shared_ptr<Side>& value)
{
    m_Side = value;
    m_SideIsSet = true;
}

bool Commandws_req_UpdateStopOrder::sideIsSet() const
{
    return m_SideIsSet;
}

void Commandws_req_UpdateStopOrder::unsetSide()
{
    m_SideIsSet = false;
}
int32_t Commandws_req_UpdateStopOrder::getQuantity() const
{
    return m_Quantity;
}

void Commandws_req_UpdateStopOrder::setQuantity(int32_t value)
{
    m_Quantity = value;
    m_QuantityIsSet = true;
}

bool Commandws_req_UpdateStopOrder::quantityIsSet() const
{
    return m_QuantityIsSet;
}

void Commandws_req_UpdateStopOrder::unsetQuantity()
{
    m_QuantityIsSet = false;
}
std::shared_ptr<Condition> Commandws_req_UpdateStopOrder::getCondition() const
{
    return m_Condition;
}

void Commandws_req_UpdateStopOrder::setCondition(const std::shared_ptr<Condition>& value)
{
    m_Condition = value;
    m_ConditionIsSet = true;
}

bool Commandws_req_UpdateStopOrder::conditionIsSet() const
{
    return m_ConditionIsSet;
}

void Commandws_req_UpdateStopOrder::unsetCondition()
{
    m_ConditionIsSet = false;
}
double Commandws_req_UpdateStopOrder::getTriggerPrice() const
{
    return m_TriggerPrice;
}

void Commandws_req_UpdateStopOrder::setTriggerPrice(double value)
{
    m_TriggerPrice = value;
    m_TriggerPriceIsSet = true;
}

bool Commandws_req_UpdateStopOrder::triggerPriceIsSet() const
{
    return m_TriggerPriceIsSet;
}

void Commandws_req_UpdateStopOrder::unsetTriggerPrice()
{
    m_TriggerPriceIsSet = false;
}
int64_t Commandws_req_UpdateStopOrder::getStopEndUnixTime() const
{
    return m_StopEndUnixTime;
}

void Commandws_req_UpdateStopOrder::setStopEndUnixTime(int64_t value)
{
    m_StopEndUnixTime = value;
    m_StopEndUnixTimeIsSet = true;
}

bool Commandws_req_UpdateStopOrder::stopEndUnixTimeIsSet() const
{
    return m_StopEndUnixTimeIsSet;
}

void Commandws_req_UpdateStopOrder::unsetStopEndUnixTime()
{
    m_StopEndUnixTimeIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument> Commandws_req_UpdateStopOrder::getInstrument() const
{
    return m_Instrument;
}

void Commandws_req_UpdateStopOrder::setInstrument(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument>& value)
{
    m_Instrument = value;
    m_InstrumentIsSet = true;
}

bool Commandws_req_UpdateStopOrder::instrumentIsSet() const
{
    return m_InstrumentIsSet;
}

void Commandws_req_UpdateStopOrder::unsetInstrument()
{
    m_InstrumentIsSet = false;
}
utility::string_t Commandws_req_UpdateStopOrder::getBoard() const
{
    return m_Board;
}

void Commandws_req_UpdateStopOrder::setBoard(const utility::string_t& value)
{
    m_Board = value;
    m_BoardIsSet = true;
}

bool Commandws_req_UpdateStopOrder::boardIsSet() const
{
    return m_BoardIsSet;
}

void Commandws_req_UpdateStopOrder::unsetBoard()
{
    m_BoardIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user> Commandws_req_UpdateStopOrder::getUser() const
{
    return m_User;
}

void Commandws_req_UpdateStopOrder::setUser(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Commandws_req_UpdateStopOrder::userIsSet() const
{
    return m_UserIsSet;
}

void Commandws_req_UpdateStopOrder::unsetUser()
{
    m_UserIsSet = false;
}
bool Commandws_req_UpdateStopOrder::isCheckDuplicates() const
{
    return m_CheckDuplicates;
}

void Commandws_req_UpdateStopOrder::setCheckDuplicates(bool value)
{
    m_CheckDuplicates = value;
    m_CheckDuplicatesIsSet = true;
}

bool Commandws_req_UpdateStopOrder::checkDuplicatesIsSet() const
{
    return m_CheckDuplicatesIsSet;
}

void Commandws_req_UpdateStopOrder::unsetCheckDuplicates()
{
    m_CheckDuplicatesIsSet = false;
}
bool Commandws_req_UpdateStopOrder::isActivate() const
{
    return m_Activate;
}

void Commandws_req_UpdateStopOrder::setActivate(bool value)
{
    m_Activate = value;
    m_ActivateIsSet = true;
}

bool Commandws_req_UpdateStopOrder::activateIsSet() const
{
    return m_ActivateIsSet;
}

void Commandws_req_UpdateStopOrder::unsetActivate()
{
    m_ActivateIsSet = false;
}
}
