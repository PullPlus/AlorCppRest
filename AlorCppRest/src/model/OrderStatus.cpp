...
{
    if (val == utility::conversions::to_string_t(U("working")))
        return OrderStatus::eOrderStatus::OrderStatus_WORKING;
    if (val == utility::conversions::to_string_t(U("filled")))
        return OrderStatus::eOrderStatus::OrderStatus_FILLED;
    if (val == utility::conversions::to_string_t(U("canceled")))
        return OrderStatus::eOrderStatus::OrderStatus_CANCELED;
    if (val == utility::conversions::to_string_t(U("rejected")))
        return OrderStatus::eOrderStatus::OrderStatus_REJECTED;
    return {};
}
...
EnumUnderlyingType fromEnum(OrderStatus::eOrderStatus e)
{
    switch (e)
    {
    case OrderStatus::eOrderStatus::OrderStatus_WORKING:
        return U("working");
    case OrderStatus::eOrderStatus::OrderStatus_FILLED:
        return U("filled");
    case OrderStatus::eOrderStatus::OrderStatus_CANCELED:
        return U("canceled");
    case OrderStatus::eOrderStatus::OrderStatus_REJECTED:
        return U("rejected");
    default:
        break;
    }
