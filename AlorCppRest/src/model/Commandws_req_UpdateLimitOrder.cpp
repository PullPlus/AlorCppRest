...
Commandws_req_UpdateLimitOrder::Commandws_req_UpdateLimitOrder()
{
...
void Commandws_req_UpdateLimitOrder::validate()
{
    // TODO: implement validation
}

web::json::value Commandws_req_UpdateLimitOrder::toJson() const
{
...
bool Commandws_req_UpdateLimitOrder::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Commandws_req_UpdateLimitOrder::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Commandws_req_UpdateLimitOrder::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Commandws_req_UpdateLimitOrder::getOpcode() const
{
    return m_Opcode;
}

void Commandws_req_UpdateLimitOrder::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Commandws_req_UpdateLimitOrder::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Commandws_req_UpdateLimitOrder::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Commandws_req_UpdateLimitOrder::getGuid() const
{
    return m_Guid;
}

void Commandws_req_UpdateLimitOrder::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Commandws_req_UpdateLimitOrder::guidIsSet() const
{
    return m_GuidIsSet;
}

void Commandws_req_UpdateLimitOrder::unsetGuid()
{
    m_GuidIsSet = false;
}
int64_t Commandws_req_UpdateLimitOrder::getOrderId() const
{
    return m_OrderId;
}

void Commandws_req_UpdateLimitOrder::setOrderId(int64_t value)
{
    m_OrderId = value;
    m_OrderIdIsSet = true;
}

bool Commandws_req_UpdateLimitOrder::orderIdIsSet() const
{
    return m_OrderIdIsSet;
}

void Commandws_req_UpdateLimitOrder::unsetOrderId()
{
    m_OrderIdIsSet = false;
}
std::shared_ptr<Side> Commandws_req_UpdateLimitOrder::getSide() const
{
    return m_Side;
}

void Commandws_req_UpdateLimitOrder::setSide(const std::shared_ptr<Side>& value)
{
    m_Side = value;
    m_SideIsSet = true;
}

bool Commandws_req_UpdateLimitOrder::sideIsSet() const
{
    return m_SideIsSet;
}

void Commandws_req_UpdateLimitOrder::unsetSide()
{
    m_SideIsSet = false;
}
int32_t Commandws_req_UpdateLimitOrder::getQuantity() const
{
    return m_Quantity;
}

void Commandws_req_UpdateLimitOrder::setQuantity(int32_t value)
{
    m_Quantity = value;
    m_QuantityIsSet = true;
}

bool Commandws_req_UpdateLimitOrder::quantityIsSet() const
{
    return m_QuantityIsSet;
}

void Commandws_req_UpdateLimitOrder::unsetQuantity()
{
    m_QuantityIsSet = false;
}
double Commandws_req_UpdateLimitOrder::getPrice() const
{
    return m_Price;
}

void Commandws_req_UpdateLimitOrder::setPrice(double value)
{
    m_Price = value;
    m_PriceIsSet = true;
}

bool Commandws_req_UpdateLimitOrder::priceIsSet() const
{
    return m_PriceIsSet;
}

void Commandws_req_UpdateLimitOrder::unsetPrice()
{
    m_PriceIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument> Commandws_req_UpdateLimitOrder::getInstrument() const
{
    return m_Instrument;
}

void Commandws_req_UpdateLimitOrder::setInstrument(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument>& value)
{
    m_Instrument = value;
    m_InstrumentIsSet = true;
}

bool Commandws_req_UpdateLimitOrder::instrumentIsSet() const
{
    return m_InstrumentIsSet;
}

void Commandws_req_UpdateLimitOrder::unsetInstrument()
{
    m_InstrumentIsSet = false;
}
utility::string_t Commandws_req_UpdateLimitOrder::getBoard() const
{
    return m_Board;
}

void Commandws_req_UpdateLimitOrder::setBoard(const utility::string_t& value)
{
    m_Board = value;
    m_BoardIsSet = true;
}

bool Commandws_req_UpdateLimitOrder::boardIsSet() const
{
    return m_BoardIsSet;
}

void Commandws_req_UpdateLimitOrder::unsetBoard()
{
    m_BoardIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user> Commandws_req_UpdateLimitOrder::getUser() const
{
    return m_User;
}

void Commandws_req_UpdateLimitOrder::setUser(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Commandws_req_UpdateLimitOrder::userIsSet() const
{
    return m_UserIsSet;
}

void Commandws_req_UpdateLimitOrder::unsetUser()
{
    m_UserIsSet = false;
}
std::shared_ptr<TimeInForce> Commandws_req_UpdateLimitOrder::getTimeInForce() const
{
    return m_TimeInForce;
}

void Commandws_req_UpdateLimitOrder::setTimeInForce(const std::shared_ptr<TimeInForce>& value)
{
    m_TimeInForce = value;
    m_TimeInForceIsSet = true;
}

bool Commandws_req_UpdateLimitOrder::timeInForceIsSet() const
{
    return m_TimeInForceIsSet;
}

void Commandws_req_UpdateLimitOrder::unsetTimeInForce()
{
    m_TimeInForceIsSet = false;
}
double Commandws_req_UpdateLimitOrder::getIcebergFixed() const
{
    return m_IcebergFixed;
}

void Commandws_req_UpdateLimitOrder::setIcebergFixed(double value)
{
    m_IcebergFixed = value;
    m_IcebergFixedIsSet = true;
}

bool Commandws_req_UpdateLimitOrder::icebergFixedIsSet() const
{
    return m_IcebergFixedIsSet;
}

void Commandws_req_UpdateLimitOrder::unsetIcebergFixed()
{
    m_IcebergFixedIsSet = false;
}
double Commandws_req_UpdateLimitOrder::getIcebergVariance() const
{
    return m_IcebergVariance;
}

void Commandws_req_UpdateLimitOrder::setIcebergVariance(double value)
{
    m_IcebergVariance = value;
    m_IcebergVarianceIsSet = true;
}

bool Commandws_req_UpdateLimitOrder::icebergVarianceIsSet() const
{
    return m_IcebergVarianceIsSet;
}

void Commandws_req_UpdateLimitOrder::unsetIcebergVariance()
{
    m_IcebergVarianceIsSet = false;
}
bool Commandws_req_UpdateLimitOrder::isCheckDuplicates() const
{
    return m_CheckDuplicates;
}

void Commandws_req_UpdateLimitOrder::setCheckDuplicates(bool value)
{
    m_CheckDuplicates = value;
    m_CheckDuplicatesIsSet = true;
}

bool Commandws_req_UpdateLimitOrder::checkDuplicatesIsSet() const
{
    return m_CheckDuplicatesIsSet;
}

void Commandws_req_UpdateLimitOrder::unsetCheckDuplicates()
{
    m_CheckDuplicatesIsSet = false;
}
}
