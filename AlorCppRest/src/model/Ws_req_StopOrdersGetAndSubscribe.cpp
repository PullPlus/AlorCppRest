...
Ws_req_StopOrdersGetAndSubscribe::Ws_req_StopOrdersGetAndSubscribe()
{
...
void Ws_req_StopOrdersGetAndSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_req_StopOrdersGetAndSubscribe::toJson() const
{
...
bool Ws_req_StopOrdersGetAndSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Ws_req_StopOrdersGetAndSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_req_StopOrdersGetAndSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Ws_req_StopOrdersGetAndSubscribe::getOpcode() const
{
    return m_Opcode;
}

void Ws_req_StopOrdersGetAndSubscribe::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Ws_req_StopOrdersGetAndSubscribe::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Ws_req_StopOrdersGetAndSubscribe::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Ws_req_StopOrdersGetAndSubscribe::getPortfolio() const
{
    return m_Portfolio;
}

void Ws_req_StopOrdersGetAndSubscribe::setPortfolio(const utility::string_t& value)
{
    m_Portfolio = value;
    m_PortfolioIsSet = true;
}

bool Ws_req_StopOrdersGetAndSubscribe::portfolioIsSet() const
{
    return m_PortfolioIsSet;
}

void Ws_req_StopOrdersGetAndSubscribe::unsetPortfolio()
{
    m_PortfolioIsSet = false;
}
utility::string_t Ws_req_StopOrdersGetAndSubscribe::getToken() const
{
    return m_Token;
}

void Ws_req_StopOrdersGetAndSubscribe::setToken(const utility::string_t& value)
{
    m_Token = value;
    m_TokenIsSet = true;
}

bool Ws_req_StopOrdersGetAndSubscribe::tokenIsSet() const
{
    return m_TokenIsSet;
}

void Ws_req_StopOrdersGetAndSubscribe::unsetToken()
{
    m_TokenIsSet = false;
}
std::shared_ptr<Exchange> Ws_req_StopOrdersGetAndSubscribe::getExchange() const
{
    return m_Exchange;
}

void Ws_req_StopOrdersGetAndSubscribe::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Ws_req_StopOrdersGetAndSubscribe::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Ws_req_StopOrdersGetAndSubscribe::unsetExchange()
{
    m_ExchangeIsSet = false;
}
std::shared_ptr<Format> Ws_req_StopOrdersGetAndSubscribe::getFormat() const
{
    return m_Format;
}

void Ws_req_StopOrdersGetAndSubscribe::setFormat(const std::shared_ptr<Format>& value)
{
    m_Format = value;
    m_FormatIsSet = true;
}

bool Ws_req_StopOrdersGetAndSubscribe::formatIsSet() const
{
    return m_FormatIsSet;
}

void Ws_req_StopOrdersGetAndSubscribe::unsetFormat()
{
    m_FormatIsSet = false;
}
utility::string_t Ws_req_StopOrdersGetAndSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_req_StopOrdersGetAndSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_req_StopOrdersGetAndSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_req_StopOrdersGetAndSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
}
