...
Ws_req_PositionsGetAndSubscribe::Ws_req_PositionsGetAndSubscribe()
{
...
void Ws_req_PositionsGetAndSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_req_PositionsGetAndSubscribe::toJson() const
{
...
bool Ws_req_PositionsGetAndSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Ws_req_PositionsGetAndSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_req_PositionsGetAndSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Ws_req_PositionsGetAndSubscribe::getOpcode() const
{
    return m_Opcode;
}

void Ws_req_PositionsGetAndSubscribe::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Ws_req_PositionsGetAndSubscribe::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Ws_req_PositionsGetAndSubscribe::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Ws_req_PositionsGetAndSubscribe::getPortfolio() const
{
    return m_Portfolio;
}

void Ws_req_PositionsGetAndSubscribe::setPortfolio(const utility::string_t& value)
{
    m_Portfolio = value;
    m_PortfolioIsSet = true;
}

bool Ws_req_PositionsGetAndSubscribe::portfolioIsSet() const
{
    return m_PortfolioIsSet;
}

void Ws_req_PositionsGetAndSubscribe::unsetPortfolio()
{
    m_PortfolioIsSet = false;
}
utility::string_t Ws_req_PositionsGetAndSubscribe::getToken() const
{
    return m_Token;
}

void Ws_req_PositionsGetAndSubscribe::setToken(const utility::string_t& value)
{
    m_Token = value;
    m_TokenIsSet = true;
}

bool Ws_req_PositionsGetAndSubscribe::tokenIsSet() const
{
    return m_TokenIsSet;
}

void Ws_req_PositionsGetAndSubscribe::unsetToken()
{
    m_TokenIsSet = false;
}
std::shared_ptr<Exchange> Ws_req_PositionsGetAndSubscribe::getExchange() const
{
    return m_Exchange;
}

void Ws_req_PositionsGetAndSubscribe::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Ws_req_PositionsGetAndSubscribe::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Ws_req_PositionsGetAndSubscribe::unsetExchange()
{
    m_ExchangeIsSet = false;
}
std::shared_ptr<Format> Ws_req_PositionsGetAndSubscribe::getFormat() const
{
    return m_Format;
}

void Ws_req_PositionsGetAndSubscribe::setFormat(const std::shared_ptr<Format>& value)
{
    m_Format = value;
    m_FormatIsSet = true;
}

bool Ws_req_PositionsGetAndSubscribe::formatIsSet() const
{
    return m_FormatIsSet;
}

void Ws_req_PositionsGetAndSubscribe::unsetFormat()
{
    m_FormatIsSet = false;
}
utility::string_t Ws_req_PositionsGetAndSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_req_PositionsGetAndSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_req_PositionsGetAndSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_req_PositionsGetAndSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
}
