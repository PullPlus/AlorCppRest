...
#include "AlorCppRest/model/Bodyrequest_ModifyOrderGroup.h"

namespace alormodel {



Bodyrequest_ModifyOrderGroup::Bodyrequest_ModifyOrderGroup()
{
    m_OrdersIsSet = false;
...
void Bodyrequest_ModifyOrderGroup::validate()
{
    // TODO: implement validation
}

web::json::value Bodyrequest_ModifyOrderGroup::toJson() const
{
...
bool Bodyrequest_ModifyOrderGroup::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Bodyrequest_ModifyOrderGroup::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bodyrequest_ModifyOrderGroup::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<OrderGroupItem>>& Bodyrequest_ModifyOrderGroup::getOrders()
{
    return m_Orders;
}

void Bodyrequest_ModifyOrderGroup::setOrders(const std::vector<std::shared_ptr<OrderGroupItem>>& value)
{
    m_Orders = value;
    m_OrdersIsSet = true;
}

bool Bodyrequest_ModifyOrderGroup::ordersIsSet() const
{
    return m_OrdersIsSet;
}

void Bodyrequest_ModifyOrderGroup::unsetOrders()
{
    m_OrdersIsSet = false;
}
std::shared_ptr<ExecutionPolicy> Bodyrequest_ModifyOrderGroup::getExecutionPolicy() const
{
    return m_ExecutionPolicy;
}

void Bodyrequest_ModifyOrderGroup::setExecutionPolicy(const std::shared_ptr<ExecutionPolicy>& value)
{
    m_ExecutionPolicy = value;
    m_ExecutionPolicyIsSet = true;
}

bool Bodyrequest_ModifyOrderGroup::executionPolicyIsSet() const
{
    return m_ExecutionPolicyIsSet;
}

void Bodyrequest_ModifyOrderGroup::unsetExecutionPolicy()
{
    m_ExecutionPolicyIsSet = false;
}
}
