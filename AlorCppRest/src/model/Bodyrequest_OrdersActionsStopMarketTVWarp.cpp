...
Bodyrequest_OrdersActionsStopMarketTVWarp::Bodyrequest_OrdersActionsStopMarketTVWarp()
{
    m_SideIsSet = false;
...
void Bodyrequest_OrdersActionsStopMarketTVWarp::validate()
{
    // TODO: implement validation
}

web::json::value Bodyrequest_OrdersActionsStopMarketTVWarp::toJson() const
{
...
bool Bodyrequest_OrdersActionsStopMarketTVWarp::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Bodyrequest_OrdersActionsStopMarketTVWarp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bodyrequest_OrdersActionsStopMarketTVWarp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Side> Bodyrequest_OrdersActionsStopMarketTVWarp::getSide() const
{
    return m_Side;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::setSide(const std::shared_ptr<Side>& value)
{
    m_Side = value;
    m_SideIsSet = true;
}

bool Bodyrequest_OrdersActionsStopMarketTVWarp::sideIsSet() const
{
    return m_SideIsSet;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::unsetSide()
{
    m_SideIsSet = false;
}
std::shared_ptr<Condition> Bodyrequest_OrdersActionsStopMarketTVWarp::getCondition() const
{
    return m_Condition;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::setCondition(const std::shared_ptr<Condition>& value)
{
    m_Condition = value;
    m_ConditionIsSet = true;
}

bool Bodyrequest_OrdersActionsStopMarketTVWarp::conditionIsSet() const
{
    return m_ConditionIsSet;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::unsetCondition()
{
    m_ConditionIsSet = false;
}
double Bodyrequest_OrdersActionsStopMarketTVWarp::getTriggerPrice() const
{
    return m_TriggerPrice;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::setTriggerPrice(double value)
{
    m_TriggerPrice = value;
    m_TriggerPriceIsSet = true;
}

bool Bodyrequest_OrdersActionsStopMarketTVWarp::triggerPriceIsSet() const
{
    return m_TriggerPriceIsSet;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::unsetTriggerPrice()
{
    m_TriggerPriceIsSet = false;
}
int64_t Bodyrequest_OrdersActionsStopMarketTVWarp::getStopEndUnixTime() const
{
    return m_StopEndUnixTime;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::setStopEndUnixTime(int64_t value)
{
    m_StopEndUnixTime = value;
    m_StopEndUnixTimeIsSet = true;
}

bool Bodyrequest_OrdersActionsStopMarketTVWarp::stopEndUnixTimeIsSet() const
{
    return m_StopEndUnixTimeIsSet;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::unsetStopEndUnixTime()
{
    m_StopEndUnixTimeIsSet = false;
}
int32_t Bodyrequest_OrdersActionsStopMarketTVWarp::getQuantity() const
{
    return m_Quantity;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::setQuantity(int32_t value)
{
    m_Quantity = value;
    m_QuantityIsSet = true;
}

bool Bodyrequest_OrdersActionsStopMarketTVWarp::quantityIsSet() const
{
    return m_QuantityIsSet;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::unsetQuantity()
{
    m_QuantityIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsStopMarketTVWarp_instrument> Bodyrequest_OrdersActionsStopMarketTVWarp::getInstrument() const
{
    return m_Instrument;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::setInstrument(const std::shared_ptr<Bodyrequest_OrdersActionsStopMarketTVWarp_instrument>& value)
{
    m_Instrument = value;
    m_InstrumentIsSet = true;
}

bool Bodyrequest_OrdersActionsStopMarketTVWarp::instrumentIsSet() const
{
    return m_InstrumentIsSet;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::unsetInstrument()
{
    m_InstrumentIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsStopMarketTVWarp_user> Bodyrequest_OrdersActionsStopMarketTVWarp::getUser() const
{
    return m_User;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::setUser(const std::shared_ptr<Bodyrequest_OrdersActionsStopMarketTVWarp_user>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Bodyrequest_OrdersActionsStopMarketTVWarp::userIsSet() const
{
    return m_UserIsSet;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::unsetUser()
{
    m_UserIsSet = false;
}
bool Bodyrequest_OrdersActionsStopMarketTVWarp::isActivate() const
{
    return m_Activate;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::setActivate(bool value)
{
    m_Activate = value;
    m_ActivateIsSet = true;
}

bool Bodyrequest_OrdersActionsStopMarketTVWarp::activateIsSet() const
{
    return m_ActivateIsSet;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp::unsetActivate()
{
    m_ActivateIsSet = false;
}
}
