...
Ws_req_TradesGetAndSubscribe::Ws_req_TradesGetAndSubscribe()
{
...
void Ws_req_TradesGetAndSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_req_TradesGetAndSubscribe::toJson() const
{
...
bool Ws_req_TradesGetAndSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Ws_req_TradesGetAndSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_req_TradesGetAndSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Ws_req_TradesGetAndSubscribe::getOpcode() const
{
    return m_Opcode;
}

void Ws_req_TradesGetAndSubscribe::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Ws_req_TradesGetAndSubscribe::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Ws_req_TradesGetAndSubscribe::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Ws_req_TradesGetAndSubscribe::getPortfolio() const
{
    return m_Portfolio;
}

void Ws_req_TradesGetAndSubscribe::setPortfolio(const utility::string_t& value)
{
    m_Portfolio = value;
    m_PortfolioIsSet = true;
}

bool Ws_req_TradesGetAndSubscribe::portfolioIsSet() const
{
    return m_PortfolioIsSet;
}

void Ws_req_TradesGetAndSubscribe::unsetPortfolio()
{
    m_PortfolioIsSet = false;
}
utility::string_t Ws_req_TradesGetAndSubscribe::getToken() const
{
    return m_Token;
}

void Ws_req_TradesGetAndSubscribe::setToken(const utility::string_t& value)
{
    m_Token = value;
    m_TokenIsSet = true;
}

bool Ws_req_TradesGetAndSubscribe::tokenIsSet() const
{
    return m_TokenIsSet;
}

void Ws_req_TradesGetAndSubscribe::unsetToken()
{
    m_TokenIsSet = false;
}
std::shared_ptr<Exchange> Ws_req_TradesGetAndSubscribe::getExchange() const
{
    return m_Exchange;
}

void Ws_req_TradesGetAndSubscribe::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Ws_req_TradesGetAndSubscribe::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Ws_req_TradesGetAndSubscribe::unsetExchange()
{
    m_ExchangeIsSet = false;
}
std::shared_ptr<Format> Ws_req_TradesGetAndSubscribe::getFormat() const
{
    return m_Format;
}

void Ws_req_TradesGetAndSubscribe::setFormat(const std::shared_ptr<Format>& value)
{
    m_Format = value;
    m_FormatIsSet = true;
}

bool Ws_req_TradesGetAndSubscribe::formatIsSet() const
{
    return m_FormatIsSet;
}

void Ws_req_TradesGetAndSubscribe::unsetFormat()
{
    m_FormatIsSet = false;
}
utility::string_t Ws_req_TradesGetAndSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_req_TradesGetAndSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_req_TradesGetAndSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_req_TradesGetAndSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
}
