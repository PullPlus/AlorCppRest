...
Commandws_req_UpdateMarketOrder::Commandws_req_UpdateMarketOrder()
{
...
void Commandws_req_UpdateMarketOrder::validate()
{
    // TODO: implement validation
}

web::json::value Commandws_req_UpdateMarketOrder::toJson() const
{
...
bool Commandws_req_UpdateMarketOrder::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Commandws_req_UpdateMarketOrder::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Commandws_req_UpdateMarketOrder::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Commandws_req_UpdateMarketOrder::getOpcode() const
{
    return m_Opcode;
}

void Commandws_req_UpdateMarketOrder::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Commandws_req_UpdateMarketOrder::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Commandws_req_UpdateMarketOrder::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Commandws_req_UpdateMarketOrder::getGuid() const
{
    return m_Guid;
}

void Commandws_req_UpdateMarketOrder::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Commandws_req_UpdateMarketOrder::guidIsSet() const
{
    return m_GuidIsSet;
}

void Commandws_req_UpdateMarketOrder::unsetGuid()
{
    m_GuidIsSet = false;
}
int64_t Commandws_req_UpdateMarketOrder::getOrderId() const
{
    return m_OrderId;
}

void Commandws_req_UpdateMarketOrder::setOrderId(int64_t value)
{
    m_OrderId = value;
    m_OrderIdIsSet = true;
}

bool Commandws_req_UpdateMarketOrder::orderIdIsSet() const
{
    return m_OrderIdIsSet;
}

void Commandws_req_UpdateMarketOrder::unsetOrderId()
{
    m_OrderIdIsSet = false;
}
std::shared_ptr<Side> Commandws_req_UpdateMarketOrder::getSide() const
{
    return m_Side;
}

void Commandws_req_UpdateMarketOrder::setSide(const std::shared_ptr<Side>& value)
{
    m_Side = value;
    m_SideIsSet = true;
}

bool Commandws_req_UpdateMarketOrder::sideIsSet() const
{
    return m_SideIsSet;
}

void Commandws_req_UpdateMarketOrder::unsetSide()
{
    m_SideIsSet = false;
}
int32_t Commandws_req_UpdateMarketOrder::getQuantity() const
{
    return m_Quantity;
}

void Commandws_req_UpdateMarketOrder::setQuantity(int32_t value)
{
    m_Quantity = value;
    m_QuantityIsSet = true;
}

bool Commandws_req_UpdateMarketOrder::quantityIsSet() const
{
    return m_QuantityIsSet;
}

void Commandws_req_UpdateMarketOrder::unsetQuantity()
{
    m_QuantityIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument> Commandws_req_UpdateMarketOrder::getInstrument() const
{
    return m_Instrument;
}

void Commandws_req_UpdateMarketOrder::setInstrument(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument>& value)
{
    m_Instrument = value;
    m_InstrumentIsSet = true;
}

bool Commandws_req_UpdateMarketOrder::instrumentIsSet() const
{
    return m_InstrumentIsSet;
}

void Commandws_req_UpdateMarketOrder::unsetInstrument()
{
    m_InstrumentIsSet = false;
}
utility::string_t Commandws_req_UpdateMarketOrder::getBoard() const
{
    return m_Board;
}

void Commandws_req_UpdateMarketOrder::setBoard(const utility::string_t& value)
{
    m_Board = value;
    m_BoardIsSet = true;
}

bool Commandws_req_UpdateMarketOrder::boardIsSet() const
{
    return m_BoardIsSet;
}

void Commandws_req_UpdateMarketOrder::unsetBoard()
{
    m_BoardIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user> Commandws_req_UpdateMarketOrder::getUser() const
{
    return m_User;
}

void Commandws_req_UpdateMarketOrder::setUser(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Commandws_req_UpdateMarketOrder::userIsSet() const
{
    return m_UserIsSet;
}

void Commandws_req_UpdateMarketOrder::unsetUser()
{
    m_UserIsSet = false;
}
bool Commandws_req_UpdateMarketOrder::isCheckDuplicates() const
{
    return m_CheckDuplicates;
}

void Commandws_req_UpdateMarketOrder::setCheckDuplicates(bool value)
{
    m_CheckDuplicates = value;
    m_CheckDuplicatesIsSet = true;
}

bool Commandws_req_UpdateMarketOrder::checkDuplicatesIsSet() const
{
    return m_CheckDuplicatesIsSet;
}

void Commandws_req_UpdateMarketOrder::unsetCheckDuplicates()
{
    m_CheckDuplicatesIsSet = false;
}
}
