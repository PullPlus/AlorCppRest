...
Bodyrequest_OrdersActionsLimitTVput_instrument::Bodyrequest_OrdersActionsLimitTVput_instrument()
{
...
void Bodyrequest_OrdersActionsLimitTVput_instrument::validate()
{
    // TODO: implement validation
}

web::json::value Bodyrequest_OrdersActionsLimitTVput_instrument::toJson() const
{
...
bool Bodyrequest_OrdersActionsLimitTVput_instrument::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Bodyrequest_OrdersActionsLimitTVput_instrument::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bodyrequest_OrdersActionsLimitTVput_instrument::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Bodyrequest_OrdersActionsLimitTVput_instrument::getSymbol() const
{
    return m_Symbol;
}

void Bodyrequest_OrdersActionsLimitTVput_instrument::setSymbol(const utility::string_t& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTVput_instrument::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void Bodyrequest_OrdersActionsLimitTVput_instrument::unsetSymbol()
{
    m_SymbolIsSet = false;
}
std::shared_ptr<Exchange> Bodyrequest_OrdersActionsLimitTVput_instrument::getExchange() const
{
    return m_Exchange;
}

void Bodyrequest_OrdersActionsLimitTVput_instrument::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTVput_instrument::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Bodyrequest_OrdersActionsLimitTVput_instrument::unsetExchange()
{
    m_ExchangeIsSet = false;
}
}
