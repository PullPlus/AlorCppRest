...
Ws_res_OrderBookGetAndSubscribe::Ws_res_OrderBookGetAndSubscribe()
{
    m_DataIsSet = false;
...
void Ws_res_OrderBookGetAndSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_res_OrderBookGetAndSubscribe::toJson() const
{
...
bool Ws_res_OrderBookGetAndSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("data"))))
    {
        ...
        {
            std::shared_ptr<Orderbook> refVal_setData;
...
void Ws_res_OrderBookGetAndSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_res_OrderBookGetAndSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Orderbook> Ws_res_OrderBookGetAndSubscribe::getData() const
{
    return m_Data;
}

void Ws_res_OrderBookGetAndSubscribe::setData(const std::shared_ptr<Orderbook>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Ws_res_OrderBookGetAndSubscribe::dataIsSet() const
{
    return m_DataIsSet;
}

void Ws_res_OrderBookGetAndSubscribe::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t Ws_res_OrderBookGetAndSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_res_OrderBookGetAndSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_res_OrderBookGetAndSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_res_OrderBookGetAndSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
}
