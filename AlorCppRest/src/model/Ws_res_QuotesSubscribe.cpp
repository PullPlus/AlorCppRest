...
Ws_res_QuotesSubscribe::Ws_res_QuotesSubscribe()
{
    m_DataIsSet = false;
...
void Ws_res_QuotesSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_res_QuotesSubscribe::toJson() const
{
...
bool Ws_res_QuotesSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("data"))))
    {
        ...
        {
            std::shared_ptr<Ws_res_QuotesSubscribe_data> refVal_setData;
...
void Ws_res_QuotesSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_res_QuotesSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Ws_res_QuotesSubscribe_data> Ws_res_QuotesSubscribe::getData() const
{
    return m_Data;
}

void Ws_res_QuotesSubscribe::setData(const std::shared_ptr<Ws_res_QuotesSubscribe_data>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Ws_res_QuotesSubscribe::dataIsSet() const
{
    return m_DataIsSet;
}

void Ws_res_QuotesSubscribe::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t Ws_res_QuotesSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_res_QuotesSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_res_QuotesSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_res_QuotesSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
}
