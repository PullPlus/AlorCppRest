...
#include "AlorCppRest/model/Bodyrequest_OrdersActionsLimitTV.h"

namespace alormodel {



Bodyrequest_OrdersActionsLimitTV::Bodyrequest_OrdersActionsLimitTV()
{
    m_SideIsSet = false;
...
void Bodyrequest_OrdersActionsLimitTV::validate()
{
    // TODO: implement validation
}

web::json::value Bodyrequest_OrdersActionsLimitTV::toJson() const
{
...
bool Bodyrequest_OrdersActionsLimitTV::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Bodyrequest_OrdersActionsLimitTV::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bodyrequest_OrdersActionsLimitTV::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Side> Bodyrequest_OrdersActionsLimitTV::getSide() const
{
    return m_Side;
}

void Bodyrequest_OrdersActionsLimitTV::setSide(const std::shared_ptr<Side>& value)
{
    m_Side = value;
    m_SideIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTV::sideIsSet() const
{
    return m_SideIsSet;
}

void Bodyrequest_OrdersActionsLimitTV::unsetSide()
{
    m_SideIsSet = false;
}
utility::string_t Bodyrequest_OrdersActionsLimitTV::getType() const
{
    return m_Type;
}

void Bodyrequest_OrdersActionsLimitTV::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTV::typeIsSet() const
{
    return m_TypeIsSet;
}

void Bodyrequest_OrdersActionsLimitTV::unsetType()
{
    m_TypeIsSet = false;
}
int32_t Bodyrequest_OrdersActionsLimitTV::getQuantity() const
{
    return m_Quantity;
}

void Bodyrequest_OrdersActionsLimitTV::setQuantity(int32_t value)
{
    m_Quantity = value;
    m_QuantityIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTV::quantityIsSet() const
{
    return m_QuantityIsSet;
}

void Bodyrequest_OrdersActionsLimitTV::unsetQuantity()
{
    m_QuantityIsSet = false;
}
double Bodyrequest_OrdersActionsLimitTV::getPrice() const
{
    return m_Price;
}

void Bodyrequest_OrdersActionsLimitTV::setPrice(double value)
{
    m_Price = value;
    m_PriceIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTV::priceIsSet() const
{
    return m_PriceIsSet;
}

void Bodyrequest_OrdersActionsLimitTV::unsetPrice()
{
    m_PriceIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument> Bodyrequest_OrdersActionsLimitTV::getInstrument() const
{
    return m_Instrument;
}

void Bodyrequest_OrdersActionsLimitTV::setInstrument(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument>& value)
{
    m_Instrument = value;
    m_InstrumentIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTV::instrumentIsSet() const
{
    return m_InstrumentIsSet;
}

void Bodyrequest_OrdersActionsLimitTV::unsetInstrument()
{
    m_InstrumentIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user> Bodyrequest_OrdersActionsLimitTV::getUser() const
{
    return m_User;
}

void Bodyrequest_OrdersActionsLimitTV::setUser(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTV::userIsSet() const
{
    return m_UserIsSet;
}

void Bodyrequest_OrdersActionsLimitTV::unsetUser()
{
    m_UserIsSet = false;
}
std::shared_ptr<TimeInForce> Bodyrequest_OrdersActionsLimitTV::getTimeInForce() const
{
    return m_TimeInForce;
}

void Bodyrequest_OrdersActionsLimitTV::setTimeInForce(const std::shared_ptr<TimeInForce>& value)
{
    m_TimeInForce = value;
    m_TimeInForceIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTV::timeInForceIsSet() const
{
    return m_TimeInForceIsSet;
}

void Bodyrequest_OrdersActionsLimitTV::unsetTimeInForce()
{
    m_TimeInForceIsSet = false;
}
int32_t Bodyrequest_OrdersActionsLimitTV::getIcebergFixed() const
{
    return m_IcebergFixed;
}

void Bodyrequest_OrdersActionsLimitTV::setIcebergFixed(int32_t value)
{
    m_IcebergFixed = value;
    m_IcebergFixedIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTV::icebergFixedIsSet() const
{
    return m_IcebergFixedIsSet;
}

void Bodyrequest_OrdersActionsLimitTV::unsetIcebergFixed()
{
    m_IcebergFixedIsSet = false;
}
double Bodyrequest_OrdersActionsLimitTV::getIcebergVariance() const
{
    return m_IcebergVariance;
}

void Bodyrequest_OrdersActionsLimitTV::setIcebergVariance(double value)
{
    m_IcebergVariance = value;
    m_IcebergVarianceIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTV::icebergVarianceIsSet() const
{
    return m_IcebergVarianceIsSet;
}

void Bodyrequest_OrdersActionsLimitTV::unsetIcebergVariance()
{
    m_IcebergVarianceIsSet = false;
}
}
