...
Ws_req_StopOrdersGetAndSubscribeV2::Ws_req_StopOrdersGetAndSubscribeV2()
{
...
void Ws_req_StopOrdersGetAndSubscribeV2::validate()
{
    // TODO: implement validation
}

web::json::value Ws_req_StopOrdersGetAndSubscribeV2::toJson() const
{
...
bool Ws_req_StopOrdersGetAndSubscribeV2::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Ws_req_StopOrdersGetAndSubscribeV2::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_req_StopOrdersGetAndSubscribeV2::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Ws_req_StopOrdersGetAndSubscribeV2::getOpcode() const
{
    return m_Opcode;
}

void Ws_req_StopOrdersGetAndSubscribeV2::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Ws_req_StopOrdersGetAndSubscribeV2::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Ws_req_StopOrdersGetAndSubscribeV2::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Ws_req_StopOrdersGetAndSubscribeV2::getPortfolio() const
{
    return m_Portfolio;
}

void Ws_req_StopOrdersGetAndSubscribeV2::setPortfolio(const utility::string_t& value)
{
    m_Portfolio = value;
    m_PortfolioIsSet = true;
}

bool Ws_req_StopOrdersGetAndSubscribeV2::portfolioIsSet() const
{
    return m_PortfolioIsSet;
}

void Ws_req_StopOrdersGetAndSubscribeV2::unsetPortfolio()
{
    m_PortfolioIsSet = false;
}
utility::string_t Ws_req_StopOrdersGetAndSubscribeV2::getToken() const
{
    return m_Token;
}

void Ws_req_StopOrdersGetAndSubscribeV2::setToken(const utility::string_t& value)
{
    m_Token = value;
    m_TokenIsSet = true;
}

bool Ws_req_StopOrdersGetAndSubscribeV2::tokenIsSet() const
{
    return m_TokenIsSet;
}

void Ws_req_StopOrdersGetAndSubscribeV2::unsetToken()
{
    m_TokenIsSet = false;
}
std::shared_ptr<Exchange> Ws_req_StopOrdersGetAndSubscribeV2::getExchange() const
{
    return m_Exchange;
}

void Ws_req_StopOrdersGetAndSubscribeV2::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Ws_req_StopOrdersGetAndSubscribeV2::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Ws_req_StopOrdersGetAndSubscribeV2::unsetExchange()
{
    m_ExchangeIsSet = false;
}
std::shared_ptr<Format> Ws_req_StopOrdersGetAndSubscribeV2::getFormat() const
{
    return m_Format;
}

void Ws_req_StopOrdersGetAndSubscribeV2::setFormat(const std::shared_ptr<Format>& value)
{
    m_Format = value;
    m_FormatIsSet = true;
}

bool Ws_req_StopOrdersGetAndSubscribeV2::formatIsSet() const
{
    return m_FormatIsSet;
}

void Ws_req_StopOrdersGetAndSubscribeV2::unsetFormat()
{
    m_FormatIsSet = false;
}
utility::string_t Ws_req_StopOrdersGetAndSubscribeV2::getGuid() const
{
    return m_Guid;
}

void Ws_req_StopOrdersGetAndSubscribeV2::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_req_StopOrdersGetAndSubscribeV2::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_req_StopOrdersGetAndSubscribeV2::unsetGuid()
{
    m_GuidIsSet = false;
}
}
