...
Ws_res_OrdersGetAndSubscribe::Ws_res_OrdersGetAndSubscribe()
{
    m_DataIsSet = false;
...
void Ws_res_OrdersGetAndSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_res_OrdersGetAndSubscribe::toJson() const
{
...
bool Ws_res_OrdersGetAndSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("data"))))
    {
        ...
        {
            std::shared_ptr<Order> refVal_setData;
...
void Ws_res_OrdersGetAndSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_res_OrdersGetAndSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Order> Ws_res_OrdersGetAndSubscribe::getData() const
{
    return m_Data;
}

void Ws_res_OrdersGetAndSubscribe::setData(const std::shared_ptr<Order>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Ws_res_OrdersGetAndSubscribe::dataIsSet() const
{
    return m_DataIsSet;
}

void Ws_res_OrdersGetAndSubscribe::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t Ws_res_OrdersGetAndSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_res_OrdersGetAndSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_res_OrdersGetAndSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_res_OrdersGetAndSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
}
