...
Ws_res_StopOrdersGetAndSubscribeWarp::Ws_res_StopOrdersGetAndSubscribeWarp()
{
    m_DataIsSet = false;
...
void Ws_res_StopOrdersGetAndSubscribeWarp::validate()
{
    // TODO: implement validation
}

web::json::value Ws_res_StopOrdersGetAndSubscribeWarp::toJson() const
{
...
bool Ws_res_StopOrdersGetAndSubscribeWarp::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("data"))))
    {
        ...
        {
            std::shared_ptr<StoporderWarp> refVal_setData;
...
void Ws_res_StopOrdersGetAndSubscribeWarp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_res_StopOrdersGetAndSubscribeWarp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<StoporderWarp> Ws_res_StopOrdersGetAndSubscribeWarp::getData() const
{
    return m_Data;
}

void Ws_res_StopOrdersGetAndSubscribeWarp::setData(const std::shared_ptr<StoporderWarp>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Ws_res_StopOrdersGetAndSubscribeWarp::dataIsSet() const
{
    return m_DataIsSet;
}

void Ws_res_StopOrdersGetAndSubscribeWarp::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t Ws_res_StopOrdersGetAndSubscribeWarp::getGuid() const
{
    return m_Guid;
}

void Ws_res_StopOrdersGetAndSubscribeWarp::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_res_StopOrdersGetAndSubscribeWarp::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_res_StopOrdersGetAndSubscribeWarp::unsetGuid()
{
    m_GuidIsSet = false;
}
}
