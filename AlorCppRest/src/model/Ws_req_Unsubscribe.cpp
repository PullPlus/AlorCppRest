...
Ws_req_Unsubscribe::Ws_req_Unsubscribe()
{
...
void Ws_req_Unsubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_req_Unsubscribe::toJson() const
{
...
bool Ws_req_Unsubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Ws_req_Unsubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_req_Unsubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Ws_req_Unsubscribe::getOpcode() const
{
    return m_Opcode;
}

void Ws_req_Unsubscribe::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Ws_req_Unsubscribe::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Ws_req_Unsubscribe::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Ws_req_Unsubscribe::getToken() const
{
    return m_Token;
}

void Ws_req_Unsubscribe::setToken(const utility::string_t& value)
{
    m_Token = value;
    m_TokenIsSet = true;
}

bool Ws_req_Unsubscribe::tokenIsSet() const
{
    return m_TokenIsSet;
}

void Ws_req_Unsubscribe::unsetToken()
{
    m_TokenIsSet = false;
}
utility::string_t Ws_req_Unsubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_req_Unsubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_req_Unsubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_req_Unsubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
}
