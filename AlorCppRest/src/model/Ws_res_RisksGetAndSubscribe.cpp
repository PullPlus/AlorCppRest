...
Ws_res_RisksGetAndSubscribe::Ws_res_RisksGetAndSubscribe()
{
    m_DataIsSet = false;
...
void Ws_res_RisksGetAndSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_res_RisksGetAndSubscribe::toJson() const
{
...
bool Ws_res_RisksGetAndSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("data"))))
    {
        ...
        {
            std::shared_ptr<Risk> refVal_setData;
...
void Ws_res_RisksGetAndSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_res_RisksGetAndSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Risk> Ws_res_RisksGetAndSubscribe::getData() const
{
    return m_Data;
}

void Ws_res_RisksGetAndSubscribe::setData(const std::shared_ptr<Risk>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Ws_res_RisksGetAndSubscribe::dataIsSet() const
{
    return m_DataIsSet;
}

void Ws_res_RisksGetAndSubscribe::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t Ws_res_RisksGetAndSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_res_RisksGetAndSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_res_RisksGetAndSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_res_RisksGetAndSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
}
