...
#include "AlorCppRest/model/Bodyrequest_OrdersActionsStop_Instrument.h"

namespace alormodel {



Bodyrequest_OrdersActionsStop_Instrument::Bodyrequest_OrdersActionsStop_Instrument()
{
...
void Bodyrequest_OrdersActionsStop_Instrument::validate()
{
    // TODO: implement validation
}

web::json::value Bodyrequest_OrdersActionsStop_Instrument::toJson() const
{
...
bool Bodyrequest_OrdersActionsStop_Instrument::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Bodyrequest_OrdersActionsStop_Instrument::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bodyrequest_OrdersActionsStop_Instrument::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Bodyrequest_OrdersActionsStop_Instrument::getSymbol() const
{
    return m_Symbol;
}

void Bodyrequest_OrdersActionsStop_Instrument::setSymbol(const utility::string_t& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool Bodyrequest_OrdersActionsStop_Instrument::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void Bodyrequest_OrdersActionsStop_Instrument::unsetSymbol()
{
    m_SymbolIsSet = false;
}
std::shared_ptr<Exchange> Bodyrequest_OrdersActionsStop_Instrument::getExchange() const
{
    return m_Exchange;
}

void Bodyrequest_OrdersActionsStop_Instrument::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Bodyrequest_OrdersActionsStop_Instrument::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Bodyrequest_OrdersActionsStop_Instrument::unsetExchange()
{
    m_ExchangeIsSet = false;
}
}
