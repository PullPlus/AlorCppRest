...
Commandws_req_Authorize::Commandws_req_Authorize()
{
...
void Commandws_req_Authorize::validate()
{
    // TODO: implement validation
}

web::json::value Commandws_req_Authorize::toJson() const
{
...
bool Commandws_req_Authorize::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Commandws_req_Authorize::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Commandws_req_Authorize::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Commandws_req_Authorize::getOpcode() const
{
    return m_Opcode;
}

void Commandws_req_Authorize::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Commandws_req_Authorize::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Commandws_req_Authorize::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Commandws_req_Authorize::getGuid() const
{
    return m_Guid;
}

void Commandws_req_Authorize::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Commandws_req_Authorize::guidIsSet() const
{
    return m_GuidIsSet;
}

void Commandws_req_Authorize::unsetGuid()
{
    m_GuidIsSet = false;
}
utility::string_t Commandws_req_Authorize::getToken() const
{
    return m_Token;
}

void Commandws_req_Authorize::setToken(const utility::string_t& value)
{
    m_Token = value;
    m_TokenIsSet = true;
}

bool Commandws_req_Authorize::tokenIsSet() const
{
    return m_TokenIsSet;
}

void Commandws_req_Authorize::unsetToken()
{
    m_TokenIsSet = false;
}
}
