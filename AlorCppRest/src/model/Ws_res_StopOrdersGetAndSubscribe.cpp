...
Ws_res_StopOrdersGetAndSubscribe::Ws_res_StopOrdersGetAndSubscribe()
{
    m_DataIsSet = false;
...
void Ws_res_StopOrdersGetAndSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_res_StopOrdersGetAndSubscribe::toJson() const
{
...
bool Ws_res_StopOrdersGetAndSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("data"))))
    {
        ...
        {
            std::shared_ptr<Stoporder> refVal_setData;
...
void Ws_res_StopOrdersGetAndSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_res_StopOrdersGetAndSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Stoporder> Ws_res_StopOrdersGetAndSubscribe::getData() const
{
    return m_Data;
}

void Ws_res_StopOrdersGetAndSubscribe::setData(const std::shared_ptr<Stoporder>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Ws_res_StopOrdersGetAndSubscribe::dataIsSet() const
{
    return m_DataIsSet;
}

void Ws_res_StopOrdersGetAndSubscribe::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t Ws_res_StopOrdersGetAndSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_res_StopOrdersGetAndSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_res_StopOrdersGetAndSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_res_StopOrdersGetAndSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
}
