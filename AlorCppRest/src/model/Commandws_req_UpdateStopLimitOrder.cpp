...
Commandws_req_UpdateStopLimitOrder::Commandws_req_UpdateStopLimitOrder()
{
...
void Commandws_req_UpdateStopLimitOrder::validate()
{
    // TODO: implement validation
}

web::json::value Commandws_req_UpdateStopLimitOrder::toJson() const
{
...
bool Commandws_req_UpdateStopLimitOrder::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Commandws_req_UpdateStopLimitOrder::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Commandws_req_UpdateStopLimitOrder::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Commandws_req_UpdateStopLimitOrder::getOpcode() const
{
    return m_Opcode;
}

void Commandws_req_UpdateStopLimitOrder::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Commandws_req_UpdateStopLimitOrder::getGuid() const
{
    return m_Guid;
}

void Commandws_req_UpdateStopLimitOrder::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::guidIsSet() const
{
    return m_GuidIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetGuid()
{
    m_GuidIsSet = false;
}
int64_t Commandws_req_UpdateStopLimitOrder::getOrderId() const
{
    return m_OrderId;
}

void Commandws_req_UpdateStopLimitOrder::setOrderId(int64_t value)
{
    m_OrderId = value;
    m_OrderIdIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::orderIdIsSet() const
{
    return m_OrderIdIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetOrderId()
{
    m_OrderIdIsSet = false;
}
std::shared_ptr<Side> Commandws_req_UpdateStopLimitOrder::getSide() const
{
    return m_Side;
}

void Commandws_req_UpdateStopLimitOrder::setSide(const std::shared_ptr<Side>& value)
{
    m_Side = value;
    m_SideIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::sideIsSet() const
{
    return m_SideIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetSide()
{
    m_SideIsSet = false;
}
int32_t Commandws_req_UpdateStopLimitOrder::getQuantity() const
{
    return m_Quantity;
}

void Commandws_req_UpdateStopLimitOrder::setQuantity(int32_t value)
{
    m_Quantity = value;
    m_QuantityIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::quantityIsSet() const
{
    return m_QuantityIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetQuantity()
{
    m_QuantityIsSet = false;
}
double Commandws_req_UpdateStopLimitOrder::getPrice() const
{
    return m_Price;
}

void Commandws_req_UpdateStopLimitOrder::setPrice(double value)
{
    m_Price = value;
    m_PriceIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::priceIsSet() const
{
    return m_PriceIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetPrice()
{
    m_PriceIsSet = false;
}
std::shared_ptr<Condition> Commandws_req_UpdateStopLimitOrder::getCondition() const
{
    return m_Condition;
}

void Commandws_req_UpdateStopLimitOrder::setCondition(const std::shared_ptr<Condition>& value)
{
    m_Condition = value;
    m_ConditionIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::conditionIsSet() const
{
    return m_ConditionIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetCondition()
{
    m_ConditionIsSet = false;
}
double Commandws_req_UpdateStopLimitOrder::getTriggerPrice() const
{
    return m_TriggerPrice;
}

void Commandws_req_UpdateStopLimitOrder::setTriggerPrice(double value)
{
    m_TriggerPrice = value;
    m_TriggerPriceIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::triggerPriceIsSet() const
{
    return m_TriggerPriceIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetTriggerPrice()
{
    m_TriggerPriceIsSet = false;
}
int64_t Commandws_req_UpdateStopLimitOrder::getStopEndUnixTime() const
{
    return m_StopEndUnixTime;
}

void Commandws_req_UpdateStopLimitOrder::setStopEndUnixTime(int64_t value)
{
    m_StopEndUnixTime = value;
    m_StopEndUnixTimeIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::stopEndUnixTimeIsSet() const
{
    return m_StopEndUnixTimeIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetStopEndUnixTime()
{
    m_StopEndUnixTimeIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument> Commandws_req_UpdateStopLimitOrder::getInstrument() const
{
    return m_Instrument;
}

void Commandws_req_UpdateStopLimitOrder::setInstrument(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument>& value)
{
    m_Instrument = value;
    m_InstrumentIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::instrumentIsSet() const
{
    return m_InstrumentIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetInstrument()
{
    m_InstrumentIsSet = false;
}
utility::string_t Commandws_req_UpdateStopLimitOrder::getBoard() const
{
    return m_Board;
}

void Commandws_req_UpdateStopLimitOrder::setBoard(const utility::string_t& value)
{
    m_Board = value;
    m_BoardIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::boardIsSet() const
{
    return m_BoardIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetBoard()
{
    m_BoardIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user> Commandws_req_UpdateStopLimitOrder::getUser() const
{
    return m_User;
}

void Commandws_req_UpdateStopLimitOrder::setUser(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::userIsSet() const
{
    return m_UserIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetUser()
{
    m_UserIsSet = false;
}
std::shared_ptr<TimeInForce> Commandws_req_UpdateStopLimitOrder::getTimeInForce() const
{
    return m_TimeInForce;
}

void Commandws_req_UpdateStopLimitOrder::setTimeInForce(const std::shared_ptr<TimeInForce>& value)
{
    m_TimeInForce = value;
    m_TimeInForceIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::timeInForceIsSet() const
{
    return m_TimeInForceIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetTimeInForce()
{
    m_TimeInForceIsSet = false;
}
double Commandws_req_UpdateStopLimitOrder::getIcebergFixed() const
{
    return m_IcebergFixed;
}

void Commandws_req_UpdateStopLimitOrder::setIcebergFixed(double value)
{
    m_IcebergFixed = value;
    m_IcebergFixedIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::icebergFixedIsSet() const
{
    return m_IcebergFixedIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetIcebergFixed()
{
    m_IcebergFixedIsSet = false;
}
double Commandws_req_UpdateStopLimitOrder::getIcebergVariance() const
{
    return m_IcebergVariance;
}

void Commandws_req_UpdateStopLimitOrder::setIcebergVariance(double value)
{
    m_IcebergVariance = value;
    m_IcebergVarianceIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::icebergVarianceIsSet() const
{
    return m_IcebergVarianceIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetIcebergVariance()
{
    m_IcebergVarianceIsSet = false;
}
bool Commandws_req_UpdateStopLimitOrder::isCheckDuplicates() const
{
    return m_CheckDuplicates;
}

void Commandws_req_UpdateStopLimitOrder::setCheckDuplicates(bool value)
{
    m_CheckDuplicates = value;
    m_CheckDuplicatesIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::checkDuplicatesIsSet() const
{
    return m_CheckDuplicatesIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetCheckDuplicates()
{
    m_CheckDuplicatesIsSet = false;
}
bool Commandws_req_UpdateStopLimitOrder::isActivate() const
{
    return m_Activate;
}

void Commandws_req_UpdateStopLimitOrder::setActivate(bool value)
{
    m_Activate = value;
    m_ActivateIsSet = true;
}

bool Commandws_req_UpdateStopLimitOrder::activateIsSet() const
{
    return m_ActivateIsSet;
}

void Commandws_req_UpdateStopLimitOrder::unsetActivate()
{
    m_ActivateIsSet = false;
}
}
