...
Bodyrequest_OrdersActionsStoplimit::Bodyrequest_OrdersActionsStoplimit()
{
    m_Quantity = 0;
...
void Bodyrequest_OrdersActionsStoplimit::validate()
{
    // TODO: implement validation
}

web::json::value Bodyrequest_OrdersActionsStoplimit::toJson() const
{
...
bool Bodyrequest_OrdersActionsStoplimit::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Bodyrequest_OrdersActionsStoplimit::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bodyrequest_OrdersActionsStoplimit::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Bodyrequest_OrdersActionsStoplimit::getQuantity() const
{
    return m_Quantity;
}

void Bodyrequest_OrdersActionsStoplimit::setQuantity(int32_t value)
{
    m_Quantity = value;
    m_QuantityIsSet = true;
}

bool Bodyrequest_OrdersActionsStoplimit::quantityIsSet() const
{
    return m_QuantityIsSet;
}

void Bodyrequest_OrdersActionsStoplimit::unsetQuantity()
{
    m_QuantityIsSet = false;
}
std::shared_ptr<Side> Bodyrequest_OrdersActionsStoplimit::getSide() const
{
    return m_Side;
}

void Bodyrequest_OrdersActionsStoplimit::setSide(const std::shared_ptr<Side>& value)
{
    m_Side = value;
    m_SideIsSet = true;
}

bool Bodyrequest_OrdersActionsStoplimit::sideIsSet() const
{
    return m_SideIsSet;
}

void Bodyrequest_OrdersActionsStoplimit::unsetSide()
{
    m_SideIsSet = false;
}
double Bodyrequest_OrdersActionsStoplimit::getTriggerPrice() const
{
    return m_TriggerPrice;
}

void Bodyrequest_OrdersActionsStoplimit::setTriggerPrice(double value)
{
    m_TriggerPrice = value;
    m_TriggerPriceIsSet = true;
}

bool Bodyrequest_OrdersActionsStoplimit::triggerPriceIsSet() const
{
    return m_TriggerPriceIsSet;
}

void Bodyrequest_OrdersActionsStoplimit::unsetTriggerPrice()
{
    m_TriggerPriceIsSet = false;
}
double Bodyrequest_OrdersActionsStoplimit::getPrice() const
{
    return m_Price;
}

void Bodyrequest_OrdersActionsStoplimit::setPrice(double value)
{
    m_Price = value;
    m_PriceIsSet = true;
}

bool Bodyrequest_OrdersActionsStoplimit::priceIsSet() const
{
    return m_PriceIsSet;
}

void Bodyrequest_OrdersActionsStoplimit::unsetPrice()
{
    m_PriceIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimit_Instrument> Bodyrequest_OrdersActionsStoplimit::getInstrument() const
{
    return m_Instrument;
}

void Bodyrequest_OrdersActionsStoplimit::setInstrument(const std::shared_ptr<Bodyrequest_OrdersActionsLimit_Instrument>& value)
{
    m_Instrument = value;
    m_InstrumentIsSet = true;
}

bool Bodyrequest_OrdersActionsStoplimit::instrumentIsSet() const
{
    return m_InstrumentIsSet;
}

void Bodyrequest_OrdersActionsStoplimit::unsetInstrument()
{
    m_InstrumentIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimit_User> Bodyrequest_OrdersActionsStoplimit::getUser() const
{
    return m_User;
}

void Bodyrequest_OrdersActionsStoplimit::setUser(const std::shared_ptr<Bodyrequest_OrdersActionsLimit_User>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Bodyrequest_OrdersActionsStoplimit::userIsSet() const
{
    return m_UserIsSet;
}

void Bodyrequest_OrdersActionsStoplimit::unsetUser()
{
    m_UserIsSet = false;
}
int64_t Bodyrequest_OrdersActionsStoplimit::getOrderEndUnixTime() const
{
    return m_OrderEndUnixTime;
}

void Bodyrequest_OrdersActionsStoplimit::setOrderEndUnixTime(int64_t value)
{
    m_OrderEndUnixTime = value;
    m_OrderEndUnixTimeIsSet = true;
}

bool Bodyrequest_OrdersActionsStoplimit::orderEndUnixTimeIsSet() const
{
    return m_OrderEndUnixTimeIsSet;
}

void Bodyrequest_OrdersActionsStoplimit::unsetOrderEndUnixTime()
{
    m_OrderEndUnixTimeIsSet = false;
}
std::shared_ptr<TimeInForce> Bodyrequest_OrdersActionsStoplimit::getTimeInForce() const
{
    return m_TimeInForce;
}

void Bodyrequest_OrdersActionsStoplimit::setTimeInForce(const std::shared_ptr<TimeInForce>& value)
{
    m_TimeInForce = value;
    m_TimeInForceIsSet = true;
}

bool Bodyrequest_OrdersActionsStoplimit::timeInForceIsSet() const
{
    return m_TimeInForceIsSet;
}

void Bodyrequest_OrdersActionsStoplimit::unsetTimeInForce()
{
    m_TimeInForceIsSet = false;
}
int32_t Bodyrequest_OrdersActionsStoplimit::getIcebergFixed() const
{
    return m_IcebergFixed;
}

void Bodyrequest_OrdersActionsStoplimit::setIcebergFixed(int32_t value)
{
    m_IcebergFixed = value;
    m_IcebergFixedIsSet = true;
}

bool Bodyrequest_OrdersActionsStoplimit::icebergFixedIsSet() const
{
    return m_IcebergFixedIsSet;
}

void Bodyrequest_OrdersActionsStoplimit::unsetIcebergFixed()
{
    m_IcebergFixedIsSet = false;
}
double Bodyrequest_OrdersActionsStoplimit::getIcebergVariance() const
{
    return m_IcebergVariance;
}

void Bodyrequest_OrdersActionsStoplimit::setIcebergVariance(double value)
{
    m_IcebergVariance = value;
    m_IcebergVarianceIsSet = true;
}

bool Bodyrequest_OrdersActionsStoplimit::icebergVarianceIsSet() const
{
    return m_IcebergVarianceIsSet;
}

void Bodyrequest_OrdersActionsStoplimit::unsetIcebergVariance()
{
    m_IcebergVarianceIsSet = false;
}
}
