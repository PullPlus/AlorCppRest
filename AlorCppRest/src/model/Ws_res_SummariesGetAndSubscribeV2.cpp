...
Ws_res_SummariesGetAndSubscribeV2::Ws_res_SummariesGetAndSubscribeV2()
{
    m_DataIsSet = false;
...
void Ws_res_SummariesGetAndSubscribeV2::validate()
{
    // TODO: implement validation
}

web::json::value Ws_res_SummariesGetAndSubscribeV2::toJson() const
{
...
bool Ws_res_SummariesGetAndSubscribeV2::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("data"))))
    {
        ...
        {
            std::shared_ptr<Ws_res_SummariesGetAndSubscribeV2_data> refVal_setData;
...
void Ws_res_SummariesGetAndSubscribeV2::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_res_SummariesGetAndSubscribeV2::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Ws_res_SummariesGetAndSubscribeV2_data> Ws_res_SummariesGetAndSubscribeV2::getData() const
{
    return m_Data;
}

void Ws_res_SummariesGetAndSubscribeV2::setData(const std::shared_ptr<Ws_res_SummariesGetAndSubscribeV2_data>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Ws_res_SummariesGetAndSubscribeV2::dataIsSet() const
{
    return m_DataIsSet;
}

void Ws_res_SummariesGetAndSubscribeV2::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t Ws_res_SummariesGetAndSubscribeV2::getGuid() const
{
    return m_Guid;
}

void Ws_res_SummariesGetAndSubscribeV2::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_res_SummariesGetAndSubscribeV2::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_res_SummariesGetAndSubscribeV2::unsetGuid()
{
    m_GuidIsSet = false;
}
}
