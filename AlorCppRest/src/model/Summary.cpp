...
double Summary::getBuyingPowerAtMorning() const
{
    return m_BuyingPowerAtMorning;
}

void Summary::setBuyingPowerAtMorning(double value)
{
    m_BuyingPowerAtMorning = value;
    m_BuyingPowerAtMorningIsSet = true;
}

bool Summary::buyingPowerAtMorningIsSet() const
{
    return m_BuyingPowerAtMorningIsSet;
}

void Summary::unsetBuyingPowerAtMorning()
{
    m_BuyingPowerAtMorningIsSet = false;
}
double Summary::getBuyingPower() const
{
    return m_BuyingPower;
}

void Summary::setBuyingPower(double value)
{
    m_BuyingPower = value;
    m_BuyingPowerIsSet = true;
}

bool Summary::buyingPowerIsSet() const
{
    return m_BuyingPowerIsSet;
}

void Summary::unsetBuyingPower()
{
    m_BuyingPowerIsSet = false;
}
double Summary::getProfit() const
{
    return m_Profit;
}

void Summary::setProfit(double value)
{
    m_Profit = value;
    m_ProfitIsSet = true;
}

bool Summary::profitIsSet() const
{
    return m_ProfitIsSet;
}

void Summary::unsetProfit()
{
    m_ProfitIsSet = false;
}
double Summary::getProfitRate() const
{
    return m_ProfitRate;
}

void Summary::setProfitRate(double value)
{
    m_ProfitRate = value;
    m_ProfitRateIsSet = true;
}

bool Summary::profitRateIsSet() const
{
    return m_ProfitRateIsSet;
}

void Summary::unsetProfitRate()
{
    m_ProfitRateIsSet = false;
}
double Summary::getPortfolioEvaluation() const
{
    return m_PortfolioEvaluation;
}

void Summary::setPortfolioEvaluation(double value)
{
    m_PortfolioEvaluation = value;
    m_PortfolioEvaluationIsSet = true;
}

bool Summary::portfolioEvaluationIsSet() const
{
    return m_PortfolioEvaluationIsSet;
}

void Summary::unsetPortfolioEvaluation()
{
    m_PortfolioEvaluationIsSet = false;
}
double Summary::getPortfolioLiquidationValue() const
{
    return m_PortfolioLiquidationValue;
}

void Summary::setPortfolioLiquidationValue(double value)
{
    m_PortfolioLiquidationValue = value;
    m_PortfolioLiquidationValueIsSet = true;
}

bool Summary::portfolioLiquidationValueIsSet() const
{
    return m_PortfolioLiquidationValueIsSet;
}

void Summary::unsetPortfolioLiquidationValue()
{
    m_PortfolioLiquidationValueIsSet = false;
}
double Summary::getInitialMargin() const
{
    return m_InitialMargin;
}

void Summary::setInitialMargin(double value)
{
    m_InitialMargin = value;
    m_InitialMarginIsSet = true;
}

bool Summary::initialMarginIsSet() const
{
    return m_InitialMarginIsSet;
}

void Summary::unsetInitialMargin()
{
    m_InitialMarginIsSet = false;
}
double Summary::getRiskBeforeForcePositionClosing() const
{
    return m_RiskBeforeForcePositionClosing;
}

void Summary::setRiskBeforeForcePositionClosing(double value)
{
    m_RiskBeforeForcePositionClosing = value;
    m_RiskBeforeForcePositionClosingIsSet = true;
}

bool Summary::riskBeforeForcePositionClosingIsSet() const
{
    return m_RiskBeforeForcePositionClosingIsSet;
}

void Summary::unsetRiskBeforeForcePositionClosing()
{
    m_RiskBeforeForcePositionClosingIsSet = false;
}
...
void Summary::setCommission(double value)
{
    m_Commission = value;
    m_CommissionIsSet = true;
}

bool Summary::commissionIsSet() const
{
    return m_CommissionIsSet;
}

void Summary::unsetCommission()
{
    m_CommissionIsSet = false;
}
}
