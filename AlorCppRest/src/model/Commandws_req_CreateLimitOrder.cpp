...
Commandws_req_CreateLimitOrder::Commandws_req_CreateLimitOrder()
{
...
void Commandws_req_CreateLimitOrder::validate()
{
    // TODO: implement validation
}

web::json::value Commandws_req_CreateLimitOrder::toJson() const
{
...
bool Commandws_req_CreateLimitOrder::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Commandws_req_CreateLimitOrder::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Commandws_req_CreateLimitOrder::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Commandws_req_CreateLimitOrder::getOpcode() const
{
    return m_Opcode;
}

void Commandws_req_CreateLimitOrder::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Commandws_req_CreateLimitOrder::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Commandws_req_CreateLimitOrder::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Commandws_req_CreateLimitOrder::getGuid() const
{
    return m_Guid;
}

void Commandws_req_CreateLimitOrder::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Commandws_req_CreateLimitOrder::guidIsSet() const
{
    return m_GuidIsSet;
}

void Commandws_req_CreateLimitOrder::unsetGuid()
{
    m_GuidIsSet = false;
}
std::shared_ptr<Side> Commandws_req_CreateLimitOrder::getSide() const
{
    return m_Side;
}

void Commandws_req_CreateLimitOrder::setSide(const std::shared_ptr<Side>& value)
{
    m_Side = value;
    m_SideIsSet = true;
}

bool Commandws_req_CreateLimitOrder::sideIsSet() const
{
    return m_SideIsSet;
}

void Commandws_req_CreateLimitOrder::unsetSide()
{
    m_SideIsSet = false;
}
int32_t Commandws_req_CreateLimitOrder::getQuantity() const
{
    return m_Quantity;
}

void Commandws_req_CreateLimitOrder::setQuantity(int32_t value)
{
    m_Quantity = value;
    m_QuantityIsSet = true;
}

bool Commandws_req_CreateLimitOrder::quantityIsSet() const
{
    return m_QuantityIsSet;
}

void Commandws_req_CreateLimitOrder::unsetQuantity()
{
    m_QuantityIsSet = false;
}
double Commandws_req_CreateLimitOrder::getPrice() const
{
    return m_Price;
}

void Commandws_req_CreateLimitOrder::setPrice(double value)
{
    m_Price = value;
    m_PriceIsSet = true;
}

bool Commandws_req_CreateLimitOrder::priceIsSet() const
{
    return m_PriceIsSet;
}

void Commandws_req_CreateLimitOrder::unsetPrice()
{
    m_PriceIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument> Commandws_req_CreateLimitOrder::getInstrument() const
{
    return m_Instrument;
}

void Commandws_req_CreateLimitOrder::setInstrument(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument>& value)
{
    m_Instrument = value;
    m_InstrumentIsSet = true;
}

bool Commandws_req_CreateLimitOrder::instrumentIsSet() const
{
    return m_InstrumentIsSet;
}

void Commandws_req_CreateLimitOrder::unsetInstrument()
{
    m_InstrumentIsSet = false;
}
utility::string_t Commandws_req_CreateLimitOrder::getBoard() const
{
    return m_Board;
}

void Commandws_req_CreateLimitOrder::setBoard(const utility::string_t& value)
{
    m_Board = value;
    m_BoardIsSet = true;
}

bool Commandws_req_CreateLimitOrder::boardIsSet() const
{
    return m_BoardIsSet;
}

void Commandws_req_CreateLimitOrder::unsetBoard()
{
    m_BoardIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user> Commandws_req_CreateLimitOrder::getUser() const
{
    return m_User;
}

void Commandws_req_CreateLimitOrder::setUser(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Commandws_req_CreateLimitOrder::userIsSet() const
{
    return m_UserIsSet;
}

void Commandws_req_CreateLimitOrder::unsetUser()
{
    m_UserIsSet = false;
}
std::shared_ptr<TimeInForce> Commandws_req_CreateLimitOrder::getTimeInForce() const
{
    return m_TimeInForce;
}

void Commandws_req_CreateLimitOrder::setTimeInForce(const std::shared_ptr<TimeInForce>& value)
{
    m_TimeInForce = value;
    m_TimeInForceIsSet = true;
}

bool Commandws_req_CreateLimitOrder::timeInForceIsSet() const
{
    return m_TimeInForceIsSet;
}

void Commandws_req_CreateLimitOrder::unsetTimeInForce()
{
    m_TimeInForceIsSet = false;
}
double Commandws_req_CreateLimitOrder::getIcebergFixed() const
{
    return m_IcebergFixed;
}

void Commandws_req_CreateLimitOrder::setIcebergFixed(double value)
{
    m_IcebergFixed = value;
    m_IcebergFixedIsSet = true;
}

bool Commandws_req_CreateLimitOrder::icebergFixedIsSet() const
{
    return m_IcebergFixedIsSet;
}

void Commandws_req_CreateLimitOrder::unsetIcebergFixed()
{
    m_IcebergFixedIsSet = false;
}
double Commandws_req_CreateLimitOrder::getIcebergVariance() const
{
    return m_IcebergVariance;
}

void Commandws_req_CreateLimitOrder::setIcebergVariance(double value)
{
    m_IcebergVariance = value;
    m_IcebergVarianceIsSet = true;
}

bool Commandws_req_CreateLimitOrder::icebergVarianceIsSet() const
{
    return m_IcebergVarianceIsSet;
}

void Commandws_req_CreateLimitOrder::unsetIcebergVariance()
{
    m_IcebergVarianceIsSet = false;
}
bool Commandws_req_CreateLimitOrder::isCheckDuplicates() const
{
    return m_CheckDuplicates;
}

void Commandws_req_CreateLimitOrder::setCheckDuplicates(bool value)
{
    m_CheckDuplicates = value;
    m_CheckDuplicatesIsSet = true;
}

bool Commandws_req_CreateLimitOrder::checkDuplicatesIsSet() const
{
    return m_CheckDuplicatesIsSet;
}

void Commandws_req_CreateLimitOrder::unsetCheckDuplicates()
{
    m_CheckDuplicatesIsSet = false;
}
}
