...
Bodyrequest_OrdersActionsStop_User::Bodyrequest_OrdersActionsStop_User()
{
...
void Bodyrequest_OrdersActionsStop_User::validate()
{
    // TODO: implement validation
}

web::json::value Bodyrequest_OrdersActionsStop_User::toJson() const
{
...
bool Bodyrequest_OrdersActionsStop_User::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Bodyrequest_OrdersActionsStop_User::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bodyrequest_OrdersActionsStop_User::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Bodyrequest_OrdersActionsStop_User::getAccount() const
{
    return m_Account;
}

void Bodyrequest_OrdersActionsStop_User::setAccount(const utility::string_t& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool Bodyrequest_OrdersActionsStop_User::accountIsSet() const
{
    return m_AccountIsSet;
}

void Bodyrequest_OrdersActionsStop_User::unsetAccount()
{
    m_AccountIsSet = false;
}
utility::string_t Bodyrequest_OrdersActionsStop_User::getPortfolio() const
{
    return m_Portfolio;
}

void Bodyrequest_OrdersActionsStop_User::setPortfolio(const utility::string_t& value)
{
    m_Portfolio = value;
    m_PortfolioIsSet = true;
}

bool Bodyrequest_OrdersActionsStop_User::portfolioIsSet() const
{
    return m_PortfolioIsSet;
}

void Bodyrequest_OrdersActionsStop_User::unsetPortfolio()
{
    m_PortfolioIsSet = false;
}
}
