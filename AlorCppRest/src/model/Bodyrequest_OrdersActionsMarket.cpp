...
#include "AlorCppRest/model/Bodyrequest_OrdersActionsMarket.h"

namespace alormodel {



Bodyrequest_OrdersActionsMarket::Bodyrequest_OrdersActionsMarket()
{
    m_Quantity = 0;
...
void Bodyrequest_OrdersActionsMarket::validate()
{
    // TODO: implement validation
}

web::json::value Bodyrequest_OrdersActionsMarket::toJson() const
{
...
bool Bodyrequest_OrdersActionsMarket::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Bodyrequest_OrdersActionsMarket::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bodyrequest_OrdersActionsMarket::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Bodyrequest_OrdersActionsMarket::getQuantity() const
{
    return m_Quantity;
}

void Bodyrequest_OrdersActionsMarket::setQuantity(int32_t value)
{
    m_Quantity = value;
    m_QuantityIsSet = true;
}

bool Bodyrequest_OrdersActionsMarket::quantityIsSet() const
{
    return m_QuantityIsSet;
}

void Bodyrequest_OrdersActionsMarket::unsetQuantity()
{
    m_QuantityIsSet = false;
}
std::shared_ptr<Side> Bodyrequest_OrdersActionsMarket::getSide() const
{
    return m_Side;
}

void Bodyrequest_OrdersActionsMarket::setSide(const std::shared_ptr<Side>& value)
{
    m_Side = value;
    m_SideIsSet = true;
}

bool Bodyrequest_OrdersActionsMarket::sideIsSet() const
{
    return m_SideIsSet;
}

void Bodyrequest_OrdersActionsMarket::unsetSide()
{
    m_SideIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimit_Instrument> Bodyrequest_OrdersActionsMarket::getInstrument() const
{
    return m_Instrument;
}

void Bodyrequest_OrdersActionsMarket::setInstrument(const std::shared_ptr<Bodyrequest_OrdersActionsLimit_Instrument>& value)
{
    m_Instrument = value;
    m_InstrumentIsSet = true;
}

bool Bodyrequest_OrdersActionsMarket::instrumentIsSet() const
{
    return m_InstrumentIsSet;
}

void Bodyrequest_OrdersActionsMarket::unsetInstrument()
{
    m_InstrumentIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimit_User> Bodyrequest_OrdersActionsMarket::getUser() const
{
    return m_User;
}

void Bodyrequest_OrdersActionsMarket::setUser(const std::shared_ptr<Bodyrequest_OrdersActionsLimit_User>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Bodyrequest_OrdersActionsMarket::userIsSet() const
{
    return m_UserIsSet;
}

void Bodyrequest_OrdersActionsMarket::unsetUser()
{
    m_UserIsSet = false;
}
int64_t Bodyrequest_OrdersActionsMarket::getOrderEndUnixTime() const
{
    return m_OrderEndUnixTime;
}

void Bodyrequest_OrdersActionsMarket::setOrderEndUnixTime(int64_t value)
{
    m_OrderEndUnixTime = value;
    m_OrderEndUnixTimeIsSet = true;
}

bool Bodyrequest_OrdersActionsMarket::orderEndUnixTimeIsSet() const
{
    return m_OrderEndUnixTimeIsSet;
}

void Bodyrequest_OrdersActionsMarket::unsetOrderEndUnixTime()
{
    m_OrderEndUnixTimeIsSet = false;
}
}
