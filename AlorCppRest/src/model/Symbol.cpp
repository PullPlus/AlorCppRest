...
web::json::value Symbol::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t(U("open_interest"))] = ModelBase::toJson(m_Open_interest);
    }
...
bool Symbol::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("open_interest"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("open_interest")));
        if(!fieldValue.is_null())
        {
            double refVal_setOpenInterest;
            ok &= ModelBase::fromJson(fieldValue, refVal_setOpenInterest);
            setOpenInterest(refVal_setOpenInterest);
        }
    }
...
void Symbol::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Open_interestIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("open_interest")), m_Open_interest));
    }
    if(m_Open_priceIsSet)
    {
...
bool Symbol::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("open_interest"))))
    {
        double refVal_setOpenInterest;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("open_interest"))), refVal_setOpenInterest );
        setOpenInterest(refVal_setOpenInterest);
    }
...
utility::string_t Symbol::getSymbol() const
{
    return m_Symbol;
}

void Symbol::setSymbol(const utility::string_t& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool Symbol::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void Symbol::unsetSymbol()
{
    m_SymbolIsSet = false;
}
std::shared_ptr<Exchange> Symbol::getExchange() const
{
    return m_Exchange;
}

void Symbol::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Symbol::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Symbol::unsetExchange()
{
    m_ExchangeIsSet = false;
}
utility::string_t Symbol::getDescription() const
{
    return m_Description;
}

void Symbol::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool Symbol::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void Symbol::unsetDescription()
{
    m_DescriptionIsSet = false;
}
...
void Symbol::setAsk(double value)
{
    m_Ask = value;
    m_AskIsSet = true;
}

bool Symbol::askIsSet() const
{
    return m_AskIsSet;
}

void Symbol::unsetAsk()
{
    m_AskIsSet = false;
}
...
void Symbol::setBid(double value)
{
    m_Bid = value;
    m_BidIsSet = true;
}

bool Symbol::bidIsSet() const
{
    return m_BidIsSet;
}

void Symbol::unsetBid()
{
    m_BidIsSet = false;
}
double Symbol::getPrevClosePrice() const
{
    return m_Prev_close_price;
}

void Symbol::setPrevClosePrice(double value)
{
    m_Prev_close_price = value;
    m_Prev_close_priceIsSet = true;
}

bool Symbol::prevClosePriceIsSet() const
{
    return m_Prev_close_priceIsSet;
}

void Symbol::unsetPrev_close_price()
{
    m_Prev_close_priceIsSet = false;
}
double Symbol::getLastPrice() const
{
    return m_Last_price;
}

void Symbol::setLastPrice(double value)
{
    m_Last_price = value;
    m_Last_priceIsSet = true;
}

bool Symbol::lastPriceIsSet() const
{
    return m_Last_priceIsSet;
}

void Symbol::unsetLast_price()
{
    m_Last_priceIsSet = false;
}
int64_t Symbol::getLastPriceTimestamp() const
{
    return m_Last_price_timestamp;
}

void Symbol::setLastPriceTimestamp(int64_t value)
{
    m_Last_price_timestamp = value;
    m_Last_price_timestampIsSet = true;
}

bool Symbol::lastPriceTimestampIsSet() const
{
    return m_Last_price_timestampIsSet;
}

void Symbol::unsetLast_price_timestamp()
{
    m_Last_price_timestampIsSet = false;
}
double Symbol::getChange() const
{
    return m_Change;
}

void Symbol::setChange(double value)
{
    m_Change = value;
    m_ChangeIsSet = true;
}

bool Symbol::changeIsSet() const
{
    return m_ChangeIsSet;
}

void Symbol::unsetChange()
{
    m_ChangeIsSet = false;
}
double Symbol::getChangePercent() const
{
    return m_Change_percent;
}

void Symbol::setChangePercent(double value)
{
    m_Change_percent = value;
    m_Change_percentIsSet = true;
}

bool Symbol::changePercentIsSet() const
{
    return m_Change_percentIsSet;
}

void Symbol::unsetChange_percent()
{
    m_Change_percentIsSet = false;
}
double Symbol::getHighPrice() const
{
    return m_High_price;
}

void Symbol::setHighPrice(double value)
{
    m_High_price = value;
    m_High_priceIsSet = true;
}

bool Symbol::highPriceIsSet() const
{
    return m_High_priceIsSet;
}

void Symbol::unsetHigh_price()
{
    m_High_priceIsSet = false;
}
double Symbol::getLowPrice() const
{
    return m_Low_price;
}

void Symbol::setLowPrice(double value)
{
    m_Low_price = value;
    m_Low_priceIsSet = true;
}

bool Symbol::lowPriceIsSet() const
{
    return m_Low_priceIsSet;
}

void Symbol::unsetLow_price()
{
    m_Low_priceIsSet = false;
}
double Symbol::getAccruedInt() const
{
    return m_AccruedInt;
}

void Symbol::setAccruedInt(double value)
{
    m_AccruedInt = value;
    m_AccruedIntIsSet = true;
}

bool Symbol::accruedIntIsSet() const
{
    return m_AccruedIntIsSet;
}

void Symbol::unsetAccruedInt()
{
    m_AccruedIntIsSet = false;
}
double Symbol::getAccruedInterest() const
{
    return m_Accrued_interest;
}

void Symbol::setAccruedInterest(double value)
{
    m_Accrued_interest = value;
    m_Accrued_interestIsSet = true;
}

bool Symbol::accruedInterestIsSet() const
{
    return m_Accrued_interestIsSet;
}

void Symbol::unsetAccrued_interest()
{
    m_Accrued_interestIsSet = false;
}
double Symbol::getVolume() const
{
    return m_Volume;
}

void Symbol::setVolume(double value)
{
    m_Volume = value;
    m_VolumeIsSet = true;
}

bool Symbol::volumeIsSet() const
{
    return m_VolumeIsSet;
}

void Symbol::unsetVolume()
{
    m_VolumeIsSet = false;
}
double Symbol::getOpenInterest() const
{
    return m_Open_interest;
}

void Symbol::setOpenInterest(double value)
{
    m_Open_interest = value;
    m_Open_interestIsSet = true;
}

bool Symbol::openInterestIsSet() const
{
    return m_Open_interestIsSet;
}

void Symbol::unsetOpen_interest()
{
    m_Open_interestIsSet = false;
}
double Symbol::getOpenPrice() const
{
    return m_Open_price;
}

void Symbol::setOpenPrice(double value)
{
    m_Open_price = value;
    m_Open_priceIsSet = true;
}

bool Symbol::openPriceIsSet() const
{
    return m_Open_priceIsSet;
}

void Symbol::unsetOpen_price()
{
    m_Open_priceIsSet = false;
}
int32_t Symbol::getYield() const
{
    return m_Yield;
}

void Symbol::setYield(int32_t value)
{
    m_Yield = value;
    m_YieldIsSet = true;
}

bool Symbol::yieldIsSet() const
{
    return m_YieldIsSet;
}

void Symbol::unsetYield()
{
    m_YieldIsSet = false;
}
double Symbol::getLotsize() const
{
    return m_Lotsize;
}

void Symbol::setLotsize(double value)
{
    m_Lotsize = value;
    m_LotsizeIsSet = true;
}

bool Symbol::lotsizeIsSet() const
{
    return m_LotsizeIsSet;
}

void Symbol::unsetLotsize()
{
    m_LotsizeIsSet = false;
}
double Symbol::getLotvalue() const
{
    return m_Lotvalue;
}

void Symbol::setLotvalue(double value)
{
    m_Lotvalue = value;
    m_LotvalueIsSet = true;
}

bool Symbol::lotvalueIsSet() const
{
    return m_LotvalueIsSet;
}

void Symbol::unsetLotvalue()
{
    m_LotvalueIsSet = false;
}
double Symbol::getFacevalue() const
{
    return m_Facevalue;
}

void Symbol::setFacevalue(double value)
{
    m_Facevalue = value;
    m_FacevalueIsSet = true;
}

bool Symbol::facevalueIsSet() const
{
    return m_FacevalueIsSet;
}

void Symbol::unsetFacevalue()
{
    m_FacevalueIsSet = false;
}
utility::string_t Symbol::getType() const
{
    return m_Type;
}

void Symbol::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool Symbol::typeIsSet() const
{
    return m_TypeIsSet;
}

void Symbol::unsetType()
{
    m_TypeIsSet = false;
}
}
