...
Ws_req_QuotesSubscribe::Ws_req_QuotesSubscribe()
{
...
void Ws_req_QuotesSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_req_QuotesSubscribe::toJson() const
{
...
bool Ws_req_QuotesSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Ws_req_QuotesSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_req_QuotesSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Ws_req_QuotesSubscribe::getOpcode() const
{
    return m_Opcode;
}

void Ws_req_QuotesSubscribe::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Ws_req_QuotesSubscribe::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Ws_req_QuotesSubscribe::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Ws_req_QuotesSubscribe::getCode() const
{
    return m_Code;
}

void Ws_req_QuotesSubscribe::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Ws_req_QuotesSubscribe::codeIsSet() const
{
    return m_CodeIsSet;
}

void Ws_req_QuotesSubscribe::unsetCode()
{
    m_CodeIsSet = false;
}
std::shared_ptr<Exchange> Ws_req_QuotesSubscribe::getExchange() const
{
    return m_Exchange;
}

void Ws_req_QuotesSubscribe::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Ws_req_QuotesSubscribe::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Ws_req_QuotesSubscribe::unsetExchange()
{
    m_ExchangeIsSet = false;
}
std::shared_ptr<Format> Ws_req_QuotesSubscribe::getFormat() const
{
    return m_Format;
}

void Ws_req_QuotesSubscribe::setFormat(const std::shared_ptr<Format>& value)
{
    m_Format = value;
    m_FormatIsSet = true;
}

bool Ws_req_QuotesSubscribe::formatIsSet() const
{
    return m_FormatIsSet;
}

void Ws_req_QuotesSubscribe::unsetFormat()
{
    m_FormatIsSet = false;
}
utility::string_t Ws_req_QuotesSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_req_QuotesSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_req_QuotesSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_req_QuotesSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
utility::string_t Ws_req_QuotesSubscribe::getToken() const
{
    return m_Token;
}

void Ws_req_QuotesSubscribe::setToken(const utility::string_t& value)
{
    m_Token = value;
    m_TokenIsSet = true;
}

bool Ws_req_QuotesSubscribe::tokenIsSet() const
{
    return m_TokenIsSet;
}

void Ws_req_QuotesSubscribe::unsetToken()
{
    m_TokenIsSet = false;
}
}
