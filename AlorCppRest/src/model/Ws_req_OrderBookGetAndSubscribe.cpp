...
Ws_req_OrderBookGetAndSubscribe::Ws_req_OrderBookGetAndSubscribe()
{
...
void Ws_req_OrderBookGetAndSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_req_OrderBookGetAndSubscribe::toJson() const
{
...
bool Ws_req_OrderBookGetAndSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Ws_req_OrderBookGetAndSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_req_OrderBookGetAndSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Ws_req_OrderBookGetAndSubscribe::getOpcode() const
{
    return m_Opcode;
}

void Ws_req_OrderBookGetAndSubscribe::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Ws_req_OrderBookGetAndSubscribe::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Ws_req_OrderBookGetAndSubscribe::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Ws_req_OrderBookGetAndSubscribe::getCode() const
{
    return m_Code;
}

void Ws_req_OrderBookGetAndSubscribe::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Ws_req_OrderBookGetAndSubscribe::codeIsSet() const
{
    return m_CodeIsSet;
}

void Ws_req_OrderBookGetAndSubscribe::unsetCode()
{
    m_CodeIsSet = false;
}
std::shared_ptr<Exchange> Ws_req_OrderBookGetAndSubscribe::getExchange() const
{
    return m_Exchange;
}

void Ws_req_OrderBookGetAndSubscribe::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Ws_req_OrderBookGetAndSubscribe::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Ws_req_OrderBookGetAndSubscribe::unsetExchange()
{
    m_ExchangeIsSet = false;
}
int32_t Ws_req_OrderBookGetAndSubscribe::getDepth() const
{
    return m_Depth;
}

void Ws_req_OrderBookGetAndSubscribe::setDepth(int32_t value)
{
    m_Depth = value;
    m_DepthIsSet = true;
}

bool Ws_req_OrderBookGetAndSubscribe::depthIsSet() const
{
    return m_DepthIsSet;
}

void Ws_req_OrderBookGetAndSubscribe::unsetDepth()
{
    m_DepthIsSet = false;
}
std::shared_ptr<Format> Ws_req_OrderBookGetAndSubscribe::getFormat() const
{
    return m_Format;
}

void Ws_req_OrderBookGetAndSubscribe::setFormat(const std::shared_ptr<Format>& value)
{
    m_Format = value;
    m_FormatIsSet = true;
}

bool Ws_req_OrderBookGetAndSubscribe::formatIsSet() const
{
    return m_FormatIsSet;
}

void Ws_req_OrderBookGetAndSubscribe::unsetFormat()
{
    m_FormatIsSet = false;
}
utility::string_t Ws_req_OrderBookGetAndSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_req_OrderBookGetAndSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_req_OrderBookGetAndSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_req_OrderBookGetAndSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
utility::string_t Ws_req_OrderBookGetAndSubscribe::getToken() const
{
    return m_Token;
}

void Ws_req_OrderBookGetAndSubscribe::setToken(const utility::string_t& value)
{
    m_Token = value;
    m_TokenIsSet = true;
}

bool Ws_req_OrderBookGetAndSubscribe::tokenIsSet() const
{
    return m_TokenIsSet;
}

void Ws_req_OrderBookGetAndSubscribe::unsetToken()
{
    m_TokenIsSet = false;
}
}
