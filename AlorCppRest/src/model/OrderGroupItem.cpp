...
#include "AlorCppRest/model/OrderGroupItem.h"
...
void OrderGroupItem::validate()
{
    // TODO: implement validation
}

web::json::value OrderGroupItem::toJson() const
{
...
bool OrderGroupItem::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("Type"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<OrderType> refVal_setType;
...
void OrderGroupItem::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OrderGroupItem::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t OrderGroupItem::getPortfolio() const
{
    return m_Portfolio;
}

void OrderGroupItem::setPortfolio(const utility::string_t& value)
{
    m_Portfolio = value;
    m_PortfolioIsSet = true;
}

bool OrderGroupItem::portfolioIsSet() const
{
    return m_PortfolioIsSet;
}

void OrderGroupItem::unsetPortfolio()
{
    m_PortfolioIsSet = false;
}
std::shared_ptr<Exchange> OrderGroupItem::getExchange() const
{
    return m_Exchange;
}

void OrderGroupItem::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool OrderGroupItem::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void OrderGroupItem::unsetExchange()
{
    m_ExchangeIsSet = false;
}
utility::string_t OrderGroupItem::getOrderId() const
{
    return m_OrderId;
}

void OrderGroupItem::setOrderId(const utility::string_t& value)
{
    m_OrderId = value;
    m_OrderIdIsSet = true;
}

bool OrderGroupItem::orderIdIsSet() const
{
    return m_OrderIdIsSet;
}

void OrderGroupItem::unsetOrderId()
{
    m_OrderIdIsSet = false;
}
std::shared_ptr<OrderType> OrderGroupItem::getType() const
{
    return m_Type;
}

void OrderGroupItem::setType(const std::shared_ptr<OrderType>& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool OrderGroupItem::typeIsSet() const
{
    return m_TypeIsSet;
}

void OrderGroupItem::unsetType()
{
    m_TypeIsSet = false;
}
}
