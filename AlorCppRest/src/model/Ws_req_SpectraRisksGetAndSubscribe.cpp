...
Ws_req_SpectraRisksGetAndSubscribe::Ws_req_SpectraRisksGetAndSubscribe()
{
...
void Ws_req_SpectraRisksGetAndSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_req_SpectraRisksGetAndSubscribe::toJson() const
{
...
bool Ws_req_SpectraRisksGetAndSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Ws_req_SpectraRisksGetAndSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_req_SpectraRisksGetAndSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Ws_req_SpectraRisksGetAndSubscribe::getOpcode() const
{
    return m_Opcode;
}

void Ws_req_SpectraRisksGetAndSubscribe::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Ws_req_SpectraRisksGetAndSubscribe::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Ws_req_SpectraRisksGetAndSubscribe::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Ws_req_SpectraRisksGetAndSubscribe::getPortfolio() const
{
    return m_Portfolio;
}

void Ws_req_SpectraRisksGetAndSubscribe::setPortfolio(const utility::string_t& value)
{
    m_Portfolio = value;
    m_PortfolioIsSet = true;
}

bool Ws_req_SpectraRisksGetAndSubscribe::portfolioIsSet() const
{
    return m_PortfolioIsSet;
}

void Ws_req_SpectraRisksGetAndSubscribe::unsetPortfolio()
{
    m_PortfolioIsSet = false;
}
utility::string_t Ws_req_SpectraRisksGetAndSubscribe::getToken() const
{
    return m_Token;
}

void Ws_req_SpectraRisksGetAndSubscribe::setToken(const utility::string_t& value)
{
    m_Token = value;
    m_TokenIsSet = true;
}

bool Ws_req_SpectraRisksGetAndSubscribe::tokenIsSet() const
{
    return m_TokenIsSet;
}

void Ws_req_SpectraRisksGetAndSubscribe::unsetToken()
{
    m_TokenIsSet = false;
}
std::shared_ptr<Exchange> Ws_req_SpectraRisksGetAndSubscribe::getExchange() const
{
    return m_Exchange;
}

void Ws_req_SpectraRisksGetAndSubscribe::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Ws_req_SpectraRisksGetAndSubscribe::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Ws_req_SpectraRisksGetAndSubscribe::unsetExchange()
{
    m_ExchangeIsSet = false;
}
std::shared_ptr<Format> Ws_req_SpectraRisksGetAndSubscribe::getFormat() const
{
    return m_Format;
}

void Ws_req_SpectraRisksGetAndSubscribe::setFormat(const std::shared_ptr<Format>& value)
{
    m_Format = value;
    m_FormatIsSet = true;
}

bool Ws_req_SpectraRisksGetAndSubscribe::formatIsSet() const
{
    return m_FormatIsSet;
}

void Ws_req_SpectraRisksGetAndSubscribe::unsetFormat()
{
    m_FormatIsSet = false;
}
utility::string_t Ws_req_SpectraRisksGetAndSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_req_SpectraRisksGetAndSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_req_SpectraRisksGetAndSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_req_SpectraRisksGetAndSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
}
