...
Commandws_req_CreateStopLimitOrder::Commandws_req_CreateStopLimitOrder()
{
...
void Commandws_req_CreateStopLimitOrder::validate()
{
    // TODO: implement validation
}

web::json::value Commandws_req_CreateStopLimitOrder::toJson() const
{
...
bool Commandws_req_CreateStopLimitOrder::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Commandws_req_CreateStopLimitOrder::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Commandws_req_CreateStopLimitOrder::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Commandws_req_CreateStopLimitOrder::getOpcode() const
{
    return m_Opcode;
}

void Commandws_req_CreateStopLimitOrder::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Commandws_req_CreateStopLimitOrder::getGuid() const
{
    return m_Guid;
}

void Commandws_req_CreateStopLimitOrder::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::guidIsSet() const
{
    return m_GuidIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetGuid()
{
    m_GuidIsSet = false;
}
std::shared_ptr<Side> Commandws_req_CreateStopLimitOrder::getSide() const
{
    return m_Side;
}

void Commandws_req_CreateStopLimitOrder::setSide(const std::shared_ptr<Side>& value)
{
    m_Side = value;
    m_SideIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::sideIsSet() const
{
    return m_SideIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetSide()
{
    m_SideIsSet = false;
}
int32_t Commandws_req_CreateStopLimitOrder::getQuantity() const
{
    return m_Quantity;
}

void Commandws_req_CreateStopLimitOrder::setQuantity(int32_t value)
{
    m_Quantity = value;
    m_QuantityIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::quantityIsSet() const
{
    return m_QuantityIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetQuantity()
{
    m_QuantityIsSet = false;
}
double Commandws_req_CreateStopLimitOrder::getPrice() const
{
    return m_Price;
}

void Commandws_req_CreateStopLimitOrder::setPrice(double value)
{
    m_Price = value;
    m_PriceIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::priceIsSet() const
{
    return m_PriceIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetPrice()
{
    m_PriceIsSet = false;
}
std::shared_ptr<Condition> Commandws_req_CreateStopLimitOrder::getCondition() const
{
    return m_Condition;
}

void Commandws_req_CreateStopLimitOrder::setCondition(const std::shared_ptr<Condition>& value)
{
    m_Condition = value;
    m_ConditionIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::conditionIsSet() const
{
    return m_ConditionIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetCondition()
{
    m_ConditionIsSet = false;
}
double Commandws_req_CreateStopLimitOrder::getTriggerPrice() const
{
    return m_TriggerPrice;
}

void Commandws_req_CreateStopLimitOrder::setTriggerPrice(double value)
{
    m_TriggerPrice = value;
    m_TriggerPriceIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::triggerPriceIsSet() const
{
    return m_TriggerPriceIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetTriggerPrice()
{
    m_TriggerPriceIsSet = false;
}
int64_t Commandws_req_CreateStopLimitOrder::getStopEndUnixTime() const
{
    return m_StopEndUnixTime;
}

void Commandws_req_CreateStopLimitOrder::setStopEndUnixTime(int64_t value)
{
    m_StopEndUnixTime = value;
    m_StopEndUnixTimeIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::stopEndUnixTimeIsSet() const
{
    return m_StopEndUnixTimeIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetStopEndUnixTime()
{
    m_StopEndUnixTimeIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument> Commandws_req_CreateStopLimitOrder::getInstrument() const
{
    return m_Instrument;
}

void Commandws_req_CreateStopLimitOrder::setInstrument(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument>& value)
{
    m_Instrument = value;
    m_InstrumentIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::instrumentIsSet() const
{
    return m_InstrumentIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetInstrument()
{
    m_InstrumentIsSet = false;
}
utility::string_t Commandws_req_CreateStopLimitOrder::getBoard() const
{
    return m_Board;
}

void Commandws_req_CreateStopLimitOrder::setBoard(const utility::string_t& value)
{
    m_Board = value;
    m_BoardIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::boardIsSet() const
{
    return m_BoardIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetBoard()
{
    m_BoardIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user> Commandws_req_CreateStopLimitOrder::getUser() const
{
    return m_User;
}

void Commandws_req_CreateStopLimitOrder::setUser(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::userIsSet() const
{
    return m_UserIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetUser()
{
    m_UserIsSet = false;
}
std::shared_ptr<TimeInForce> Commandws_req_CreateStopLimitOrder::getTimeInForce() const
{
    return m_TimeInForce;
}

void Commandws_req_CreateStopLimitOrder::setTimeInForce(const std::shared_ptr<TimeInForce>& value)
{
    m_TimeInForce = value;
    m_TimeInForceIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::timeInForceIsSet() const
{
    return m_TimeInForceIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetTimeInForce()
{
    m_TimeInForceIsSet = false;
}
double Commandws_req_CreateStopLimitOrder::getIcebergFixed() const
{
    return m_IcebergFixed;
}

void Commandws_req_CreateStopLimitOrder::setIcebergFixed(double value)
{
    m_IcebergFixed = value;
    m_IcebergFixedIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::icebergFixedIsSet() const
{
    return m_IcebergFixedIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetIcebergFixed()
{
    m_IcebergFixedIsSet = false;
}
double Commandws_req_CreateStopLimitOrder::getIcebergVariance() const
{
    return m_IcebergVariance;
}

void Commandws_req_CreateStopLimitOrder::setIcebergVariance(double value)
{
    m_IcebergVariance = value;
    m_IcebergVarianceIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::icebergVarianceIsSet() const
{
    return m_IcebergVarianceIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetIcebergVariance()
{
    m_IcebergVarianceIsSet = false;
}
bool Commandws_req_CreateStopLimitOrder::isCheckDuplicates() const
{
    return m_CheckDuplicates;
}

void Commandws_req_CreateStopLimitOrder::setCheckDuplicates(bool value)
{
    m_CheckDuplicates = value;
    m_CheckDuplicatesIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::checkDuplicatesIsSet() const
{
    return m_CheckDuplicatesIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetCheckDuplicates()
{
    m_CheckDuplicatesIsSet = false;
}
bool Commandws_req_CreateStopLimitOrder::isActivate() const
{
    return m_Activate;
}

void Commandws_req_CreateStopLimitOrder::setActivate(bool value)
{
    m_Activate = value;
    m_ActivateIsSet = true;
}

bool Commandws_req_CreateStopLimitOrder::activateIsSet() const
{
    return m_ActivateIsSet;
}

void Commandws_req_CreateStopLimitOrder::unsetActivate()
{
    m_ActivateIsSet = false;
}
}
