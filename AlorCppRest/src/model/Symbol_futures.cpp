...
void Symbol_futures::validate()
{
    // TODO: implement validation
}

web::json::value Symbol_futures::toJson() const
{
...
bool Symbol_futures::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Symbol_futures::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Symbol_futures::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Symbol_futures::getSymbol() const
{
    return m_Symbol;
}

void Symbol_futures::setSymbol(const utility::string_t& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool Symbol_futures::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void Symbol_futures::unsetSymbol()
{
    m_SymbolIsSet = false;
}
std::shared_ptr<Exchange> Symbol_futures::getExchange() const
{
    return m_Exchange;
}

void Symbol_futures::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Symbol_futures::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Symbol_futures::unsetExchange()
{
    m_ExchangeIsSet = false;
}
utility::string_t Symbol_futures::getDescription() const
{
    return m_Description;
}

void Symbol_futures::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool Symbol_futures::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void Symbol_futures::unsetDescription()
{
    m_DescriptionIsSet = false;
}
double Symbol_futures::getAsk() const
{
    return m_Ask;
}

void Symbol_futures::setAsk(double value)
{
    m_Ask = value;
    m_AskIsSet = true;
}

bool Symbol_futures::askIsSet() const
{
    return m_AskIsSet;
}

void Symbol_futures::unsetAsk()
{
    m_AskIsSet = false;
}
double Symbol_futures::getBid() const
{
    return m_Bid;
}

void Symbol_futures::setBid(double value)
{
    m_Bid = value;
    m_BidIsSet = true;
}

bool Symbol_futures::bidIsSet() const
{
    return m_BidIsSet;
}

void Symbol_futures::unsetBid()
{
    m_BidIsSet = false;
}
double Symbol_futures::getPrevClosePrice() const
{
    return m_Prev_close_price;
}

void Symbol_futures::setPrevClosePrice(double value)
{
    m_Prev_close_price = value;
    m_Prev_close_priceIsSet = true;
}

bool Symbol_futures::prevClosePriceIsSet() const
{
    return m_Prev_close_priceIsSet;
}

void Symbol_futures::unsetPrev_close_price()
{
    m_Prev_close_priceIsSet = false;
}
double Symbol_futures::getLastPrice() const
{
    return m_Last_price;
}

void Symbol_futures::setLastPrice(double value)
{
    m_Last_price = value;
    m_Last_priceIsSet = true;
}

bool Symbol_futures::lastPriceIsSet() const
{
    return m_Last_priceIsSet;
}

void Symbol_futures::unsetLast_price()
{
    m_Last_priceIsSet = false;
}
int64_t Symbol_futures::getLastPriceTimestamp() const
{
    return m_Last_price_timestamp;
}

void Symbol_futures::setLastPriceTimestamp(int64_t value)
{
    m_Last_price_timestamp = value;
    m_Last_price_timestampIsSet = true;
}

bool Symbol_futures::lastPriceTimestampIsSet() const
{
    return m_Last_price_timestampIsSet;
}

void Symbol_futures::unsetLast_price_timestamp()
{
    m_Last_price_timestampIsSet = false;
}
double Symbol_futures::getChange() const
{
    return m_Change;
}

void Symbol_futures::setChange(double value)
{
    m_Change = value;
    m_ChangeIsSet = true;
}

bool Symbol_futures::changeIsSet() const
{
    return m_ChangeIsSet;
}

void Symbol_futures::unsetChange()
{
    m_ChangeIsSet = false;
}
double Symbol_futures::getChangePercent() const
{
    return m_Change_percent;
}

void Symbol_futures::setChangePercent(double value)
{
    m_Change_percent = value;
    m_Change_percentIsSet = true;
}

bool Symbol_futures::changePercentIsSet() const
{
    return m_Change_percentIsSet;
}

void Symbol_futures::unsetChange_percent()
{
    m_Change_percentIsSet = false;
}
double Symbol_futures::getHighPrice() const
{
    return m_High_price;
}

void Symbol_futures::setHighPrice(double value)
{
    m_High_price = value;
    m_High_priceIsSet = true;
}

bool Symbol_futures::highPriceIsSet() const
{
    return m_High_priceIsSet;
}

void Symbol_futures::unsetHigh_price()
{
    m_High_priceIsSet = false;
}
double Symbol_futures::getLowPrice() const
{
    return m_Low_price;
}

void Symbol_futures::setLowPrice(double value)
{
    m_Low_price = value;
    m_Low_priceIsSet = true;
}

bool Symbol_futures::lowPriceIsSet() const
{
    return m_Low_priceIsSet;
}

void Symbol_futures::unsetLow_price()
{
    m_Low_priceIsSet = false;
}
double Symbol_futures::getAccruedInt() const
{
    return m_AccruedInt;
}

void Symbol_futures::setAccruedInt(double value)
{
    m_AccruedInt = value;
    m_AccruedIntIsSet = true;
}

bool Symbol_futures::accruedIntIsSet() const
{
    return m_AccruedIntIsSet;
}

void Symbol_futures::unsetAccruedInt()
{
    m_AccruedIntIsSet = false;
}
double Symbol_futures::getAccruedInterest() const
{
    return m_Accrued_interest;
}

void Symbol_futures::setAccruedInterest(double value)
{
    m_Accrued_interest = value;
    m_Accrued_interestIsSet = true;
}

bool Symbol_futures::accruedInterestIsSet() const
{
    return m_Accrued_interestIsSet;
}

void Symbol_futures::unsetAccrued_interest()
{
    m_Accrued_interestIsSet = false;
}
double Symbol_futures::getVolume() const
{
    return m_Volume;
}

void Symbol_futures::setVolume(double value)
{
    m_Volume = value;
    m_VolumeIsSet = true;
}

bool Symbol_futures::volumeIsSet() const
{
    return m_VolumeIsSet;
}

void Symbol_futures::unsetVolume()
{
    m_VolumeIsSet = false;
}
double Symbol_futures::getOpenPrice() const
{
    return m_Open_price;
}

void Symbol_futures::setOpenPrice(double value)
{
    m_Open_price = value;
    m_Open_priceIsSet = true;
}

bool Symbol_futures::openPriceIsSet() const
{
    return m_Open_priceIsSet;
}

void Symbol_futures::unsetOpen_price()
{
    m_Open_priceIsSet = false;
}
int32_t Symbol_futures::getYield() const
{
    return m_Yield;
}

void Symbol_futures::setYield(int32_t value)
{
    m_Yield = value;
    m_YieldIsSet = true;
}

bool Symbol_futures::yieldIsSet() const
{
    return m_YieldIsSet;
}

void Symbol_futures::unsetYield()
{
    m_YieldIsSet = false;
}
double Symbol_futures::getLotsize() const
{
    return m_Lotsize;
}

void Symbol_futures::setLotsize(double value)
{
    m_Lotsize = value;
    m_LotsizeIsSet = true;
}

bool Symbol_futures::lotsizeIsSet() const
{
    return m_LotsizeIsSet;
}

void Symbol_futures::unsetLotsize()
{
    m_LotsizeIsSet = false;
}
double Symbol_futures::getLotvalue() const
{
    return m_Lotvalue;
}

void Symbol_futures::setLotvalue(double value)
{
    m_Lotvalue = value;
    m_LotvalueIsSet = true;
}

bool Symbol_futures::lotvalueIsSet() const
{
    return m_LotvalueIsSet;
}

void Symbol_futures::unsetLotvalue()
{
    m_LotvalueIsSet = false;
}
double Symbol_futures::getFacevalue() const
{
    return m_Facevalue;
}

void Symbol_futures::setFacevalue(double value)
{
    m_Facevalue = value;
    m_FacevalueIsSet = true;
}

bool Symbol_futures::facevalueIsSet() const
{
    return m_FacevalueIsSet;
}

void Symbol_futures::unsetFacevalue()
{
    m_FacevalueIsSet = false;
}
utility::string_t Symbol_futures::getType() const
{
    return m_Type;
}

void Symbol_futures::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool Symbol_futures::typeIsSet() const
{
    return m_TypeIsSet;
}

void Symbol_futures::unsetType()
{
    m_TypeIsSet = false;
}
}
