...
Ws_req_OrdersGetAndSubscribe::Ws_req_OrdersGetAndSubscribe()
{
...
void Ws_req_OrdersGetAndSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_req_OrdersGetAndSubscribe::toJson() const
{
    ...
    if(m_OrderStatusesIsSet)
    {
        val[utility::conversions::to_string_t(U("orderStatuses"))] = ModelBase::toJson(m_OrderStatuses);
    }

    return val;
}

bool Ws_req_OrdersGetAndSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("orderStatuses"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("orderStatuses")));
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<OrderStatus>> refVal_setOrderStatuses;
            ok &= ModelBase::fromJson(fieldValue, refVal_setOrderStatuses);
            setOrderStatuses(refVal_setOrderStatuses);
        }
    }
    return ok;
}

void Ws_req_OrdersGetAndSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_OrderStatusesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("orderStatuses")), m_OrderStatuses));
    }
}

bool Ws_req_OrdersGetAndSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("orderStatuses"))))
    {
        std::vector<std::shared_ptr<OrderStatus>> refVal_setOrderStatuses;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("orderStatuses"))), refVal_setOrderStatuses );
        setOrderStatuses(refVal_setOrderStatuses);
    }
    return ok;
}

utility::string_t Ws_req_OrdersGetAndSubscribe::getOpcode() const
{
    return m_Opcode;
}

void Ws_req_OrdersGetAndSubscribe::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Ws_req_OrdersGetAndSubscribe::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Ws_req_OrdersGetAndSubscribe::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Ws_req_OrdersGetAndSubscribe::getPortfolio() const
{
    return m_Portfolio;
}

void Ws_req_OrdersGetAndSubscribe::setPortfolio(const utility::string_t& value)
{
    m_Portfolio = value;
    m_PortfolioIsSet = true;
}

bool Ws_req_OrdersGetAndSubscribe::portfolioIsSet() const
{
    return m_PortfolioIsSet;
}

void Ws_req_OrdersGetAndSubscribe::unsetPortfolio()
{
    m_PortfolioIsSet = false;
}
utility::string_t Ws_req_OrdersGetAndSubscribe::getToken() const
{
    return m_Token;
}

void Ws_req_OrdersGetAndSubscribe::setToken(const utility::string_t& value)
{
    m_Token = value;
    m_TokenIsSet = true;
}

bool Ws_req_OrdersGetAndSubscribe::tokenIsSet() const
{
    return m_TokenIsSet;
}

void Ws_req_OrdersGetAndSubscribe::unsetToken()
{
    m_TokenIsSet = false;
}
std::shared_ptr<Exchange> Ws_req_OrdersGetAndSubscribe::getExchange() const
{
    return m_Exchange;
}

void Ws_req_OrdersGetAndSubscribe::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Ws_req_OrdersGetAndSubscribe::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Ws_req_OrdersGetAndSubscribe::unsetExchange()
{
    m_ExchangeIsSet = false;
}
std::shared_ptr<Format> Ws_req_OrdersGetAndSubscribe::getFormat() const
{
    return m_Format;
}

void Ws_req_OrdersGetAndSubscribe::setFormat(const std::shared_ptr<Format>& value)
{
    m_Format = value;
    m_FormatIsSet = true;
}

bool Ws_req_OrdersGetAndSubscribe::formatIsSet() const
{
    return m_FormatIsSet;
}

void Ws_req_OrdersGetAndSubscribe::unsetFormat()
{
    m_FormatIsSet = false;
}
utility::string_t Ws_req_OrdersGetAndSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_req_OrdersGetAndSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_req_OrdersGetAndSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_req_OrdersGetAndSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
std::vector<std::shared_ptr<OrderStatus>>& Ws_req_OrdersGetAndSubscribe::getOrderStatuses()
{
    return m_OrderStatuses;
}

void Ws_req_OrdersGetAndSubscribe::setOrderStatuses(const std::vector<std::shared_ptr<OrderStatus>>& value)
{
    m_OrderStatuses = value;
    m_OrderStatusesIsSet = true;
}

bool Ws_req_OrdersGetAndSubscribe::orderStatusesIsSet() const
{
    return m_OrderStatusesIsSet;
}

void Ws_req_OrdersGetAndSubscribe::unsetOrderStatuses()
{
    m_OrderStatusesIsSet = false;
}
}
