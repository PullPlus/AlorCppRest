...
#include "AlorCppRest/model/Bodyrequest_OrdersActionsLimitTVput.h"

namespace alormodel {



Bodyrequest_OrdersActionsLimitTVput::Bodyrequest_OrdersActionsLimitTVput()
{
    m_SideIsSet = false;
...
void Bodyrequest_OrdersActionsLimitTVput::validate()
{
    // TODO: implement validation
}

web::json::value Bodyrequest_OrdersActionsLimitTVput::toJson() const
{
...
bool Bodyrequest_OrdersActionsLimitTVput::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Bodyrequest_OrdersActionsLimitTVput::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bodyrequest_OrdersActionsLimitTVput::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Side> Bodyrequest_OrdersActionsLimitTVput::getSide() const
{
    return m_Side;
}

void Bodyrequest_OrdersActionsLimitTVput::setSide(const std::shared_ptr<Side>& value)
{
    m_Side = value;
    m_SideIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTVput::sideIsSet() const
{
    return m_SideIsSet;
}

void Bodyrequest_OrdersActionsLimitTVput::unsetSide()
{
    m_SideIsSet = false;
}
utility::string_t Bodyrequest_OrdersActionsLimitTVput::getType() const
{
    return m_Type;
}

void Bodyrequest_OrdersActionsLimitTVput::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTVput::typeIsSet() const
{
    return m_TypeIsSet;
}

void Bodyrequest_OrdersActionsLimitTVput::unsetType()
{
    m_TypeIsSet = false;
}
int64_t Bodyrequest_OrdersActionsLimitTVput::getId() const
{
    return m_Id;
}

void Bodyrequest_OrdersActionsLimitTVput::setId(int64_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTVput::idIsSet() const
{
    return m_IdIsSet;
}

void Bodyrequest_OrdersActionsLimitTVput::unsetId()
{
    m_IdIsSet = false;
}
int32_t Bodyrequest_OrdersActionsLimitTVput::getQuantity() const
{
    return m_Quantity;
}

void Bodyrequest_OrdersActionsLimitTVput::setQuantity(int32_t value)
{
    m_Quantity = value;
    m_QuantityIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTVput::quantityIsSet() const
{
    return m_QuantityIsSet;
}

void Bodyrequest_OrdersActionsLimitTVput::unsetQuantity()
{
    m_QuantityIsSet = false;
}
double Bodyrequest_OrdersActionsLimitTVput::getPrice() const
{
    return m_Price;
}

void Bodyrequest_OrdersActionsLimitTVput::setPrice(double value)
{
    m_Price = value;
    m_PriceIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTVput::priceIsSet() const
{
    return m_PriceIsSet;
}

void Bodyrequest_OrdersActionsLimitTVput::unsetPrice()
{
    m_PriceIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument> Bodyrequest_OrdersActionsLimitTVput::getInstrument() const
{
    return m_Instrument;
}

void Bodyrequest_OrdersActionsLimitTVput::setInstrument(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument>& value)
{
    m_Instrument = value;
    m_InstrumentIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTVput::instrumentIsSet() const
{
    return m_InstrumentIsSet;
}

void Bodyrequest_OrdersActionsLimitTVput::unsetInstrument()
{
    m_InstrumentIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user> Bodyrequest_OrdersActionsLimitTVput::getUser() const
{
    return m_User;
}

void Bodyrequest_OrdersActionsLimitTVput::setUser(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTVput::userIsSet() const
{
    return m_UserIsSet;
}

void Bodyrequest_OrdersActionsLimitTVput::unsetUser()
{
    m_UserIsSet = false;
}
std::shared_ptr<TimeInForce> Bodyrequest_OrdersActionsLimitTVput::getTimeInForce() const
{
    return m_TimeInForce;
}

void Bodyrequest_OrdersActionsLimitTVput::setTimeInForce(const std::shared_ptr<TimeInForce>& value)
{
    m_TimeInForce = value;
    m_TimeInForceIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTVput::timeInForceIsSet() const
{
    return m_TimeInForceIsSet;
}

void Bodyrequest_OrdersActionsLimitTVput::unsetTimeInForce()
{
    m_TimeInForceIsSet = false;
}
int32_t Bodyrequest_OrdersActionsLimitTVput::getIcebergFixed() const
{
    return m_IcebergFixed;
}

void Bodyrequest_OrdersActionsLimitTVput::setIcebergFixed(int32_t value)
{
    m_IcebergFixed = value;
    m_IcebergFixedIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTVput::icebergFixedIsSet() const
{
    return m_IcebergFixedIsSet;
}

void Bodyrequest_OrdersActionsLimitTVput::unsetIcebergFixed()
{
    m_IcebergFixedIsSet = false;
}
double Bodyrequest_OrdersActionsLimitTVput::getIcebergVariance() const
{
    return m_IcebergVariance;
}

void Bodyrequest_OrdersActionsLimitTVput::setIcebergVariance(double value)
{
    m_IcebergVariance = value;
    m_IcebergVarianceIsSet = true;
}

bool Bodyrequest_OrdersActionsLimitTVput::icebergVarianceIsSet() const
{
    return m_IcebergVarianceIsSet;
}

void Bodyrequest_OrdersActionsLimitTVput::unsetIcebergVariance()
{
    m_IcebergVarianceIsSet = false;
}
}
