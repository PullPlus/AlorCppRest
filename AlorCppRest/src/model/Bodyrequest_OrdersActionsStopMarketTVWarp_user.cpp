...
Bodyrequest_OrdersActionsStopMarketTVWarp_user::Bodyrequest_OrdersActionsStopMarketTVWarp_user()
{
...
void Bodyrequest_OrdersActionsStopMarketTVWarp_user::validate()
{
    // TODO: implement validation
}

web::json::value Bodyrequest_OrdersActionsStopMarketTVWarp_user::toJson() const
{
...
bool Bodyrequest_OrdersActionsStopMarketTVWarp_user::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Bodyrequest_OrdersActionsStopMarketTVWarp_user::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bodyrequest_OrdersActionsStopMarketTVWarp_user::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Bodyrequest_OrdersActionsStopMarketTVWarp_user::getPortfolio() const
{
    return m_Portfolio;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp_user::setPortfolio(const utility::string_t& value)
{
    m_Portfolio = value;
    m_PortfolioIsSet = true;
}

bool Bodyrequest_OrdersActionsStopMarketTVWarp_user::portfolioIsSet() const
{
    return m_PortfolioIsSet;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp_user::unsetPortfolio()
{
    m_PortfolioIsSet = false;
}
std::shared_ptr<Exchange> Bodyrequest_OrdersActionsStopMarketTVWarp_user::getExchange() const
{
    return m_Exchange;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp_user::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Bodyrequest_OrdersActionsStopMarketTVWarp_user::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Bodyrequest_OrdersActionsStopMarketTVWarp_user::unsetExchange()
{
    m_ExchangeIsSet = false;
}
}
