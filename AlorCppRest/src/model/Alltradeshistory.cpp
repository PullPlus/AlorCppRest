...
Alltradeshistory::Alltradeshistory()
{
    m_Total = 0;
    m_TotalIsSet = false;
    m_ListIsSet = false;
...
void Alltradeshistory::validate()
{
    // TODO: implement validation
}

web::json::value Alltradeshistory::toJson() const
{
...
bool Alltradeshistory::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("list"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Alltrade>> refVal_setList;
...
void Alltradeshistory::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Alltradeshistory::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Alltradeshistory::getTotal() const
{
    return m_Total;
}

void Alltradeshistory::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool Alltradeshistory::totalIsSet() const
{
    return m_TotalIsSet;
}

void Alltradeshistory::unsetTotal()
{
    m_TotalIsSet = false;
}
std::vector<std::shared_ptr<Alltrade>>& Alltradeshistory::getList()
{
    return m_List;
}

void Alltradeshistory::setList(const std::vector<std::shared_ptr<Alltrade>>& value)
{
    m_List = value;
    m_ListIsSet = true;
}

bool Alltradeshistory::listIsSet() const
{
    return m_ListIsSet;
}

void Alltradeshistory::unsetList()
{
    m_ListIsSet = false;
}
}
