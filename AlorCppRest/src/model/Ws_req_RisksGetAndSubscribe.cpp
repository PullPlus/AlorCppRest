...
Ws_req_RisksGetAndSubscribe::Ws_req_RisksGetAndSubscribe()
{
...
void Ws_req_RisksGetAndSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_req_RisksGetAndSubscribe::toJson() const
{
...
bool Ws_req_RisksGetAndSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Ws_req_RisksGetAndSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_req_RisksGetAndSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Ws_req_RisksGetAndSubscribe::getOpcode() const
{
    return m_Opcode;
}

void Ws_req_RisksGetAndSubscribe::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Ws_req_RisksGetAndSubscribe::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Ws_req_RisksGetAndSubscribe::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Ws_req_RisksGetAndSubscribe::getPortfolio() const
{
    return m_Portfolio;
}

void Ws_req_RisksGetAndSubscribe::setPortfolio(const utility::string_t& value)
{
    m_Portfolio = value;
    m_PortfolioIsSet = true;
}

bool Ws_req_RisksGetAndSubscribe::portfolioIsSet() const
{
    return m_PortfolioIsSet;
}

void Ws_req_RisksGetAndSubscribe::unsetPortfolio()
{
    m_PortfolioIsSet = false;
}
utility::string_t Ws_req_RisksGetAndSubscribe::getToken() const
{
    return m_Token;
}

void Ws_req_RisksGetAndSubscribe::setToken(const utility::string_t& value)
{
    m_Token = value;
    m_TokenIsSet = true;
}

bool Ws_req_RisksGetAndSubscribe::tokenIsSet() const
{
    return m_TokenIsSet;
}

void Ws_req_RisksGetAndSubscribe::unsetToken()
{
    m_TokenIsSet = false;
}
std::shared_ptr<Exchange> Ws_req_RisksGetAndSubscribe::getExchange() const
{
    return m_Exchange;
}

void Ws_req_RisksGetAndSubscribe::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Ws_req_RisksGetAndSubscribe::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Ws_req_RisksGetAndSubscribe::unsetExchange()
{
    m_ExchangeIsSet = false;
}
std::shared_ptr<Format> Ws_req_RisksGetAndSubscribe::getFormat() const
{
    return m_Format;
}

void Ws_req_RisksGetAndSubscribe::setFormat(const std::shared_ptr<Format>& value)
{
    m_Format = value;
    m_FormatIsSet = true;
}

bool Ws_req_RisksGetAndSubscribe::formatIsSet() const
{
    return m_FormatIsSet;
}

void Ws_req_RisksGetAndSubscribe::unsetFormat()
{
    m_FormatIsSet = false;
}
utility::string_t Ws_req_RisksGetAndSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_req_RisksGetAndSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_req_RisksGetAndSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_req_RisksGetAndSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
}
