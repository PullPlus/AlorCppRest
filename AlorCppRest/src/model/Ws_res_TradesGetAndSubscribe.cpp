...
Ws_res_TradesGetAndSubscribe::Ws_res_TradesGetAndSubscribe()
{
    m_DataIsSet = false;
...
void Ws_res_TradesGetAndSubscribe::validate()
{
    // TODO: implement validation
}

web::json::value Ws_res_TradesGetAndSubscribe::toJson() const
{
...
bool Ws_res_TradesGetAndSubscribe::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("data"))))
    {
        ...
        {
            std::shared_ptr<Trade> refVal_setData;
...
void Ws_res_TradesGetAndSubscribe::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ws_res_TradesGetAndSubscribe::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Trade> Ws_res_TradesGetAndSubscribe::getData() const
{
    return m_Data;
}

void Ws_res_TradesGetAndSubscribe::setData(const std::shared_ptr<Trade>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Ws_res_TradesGetAndSubscribe::dataIsSet() const
{
    return m_DataIsSet;
}

void Ws_res_TradesGetAndSubscribe::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t Ws_res_TradesGetAndSubscribe::getGuid() const
{
    return m_Guid;
}

void Ws_res_TradesGetAndSubscribe::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Ws_res_TradesGetAndSubscribe::guidIsSet() const
{
    return m_GuidIsSet;
}

void Ws_res_TradesGetAndSubscribe::unsetGuid()
{
    m_GuidIsSet = false;
}
}
