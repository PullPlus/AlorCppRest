...
void RiskRates::validate()
{
    // TODO: implement validation
}

web::json::value RiskRates::toJson() const
{
...
bool RiskRates::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("list"))))
    {
        ...
        {
            std::vector<std::shared_ptr<RiskRate>> refVal_setList;
...
void RiskRates::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RiskRates::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<RiskRate>>& RiskRates::getList()
{
    return m_List;
}

void RiskRates::setList(const std::vector<std::shared_ptr<RiskRate>>& value)
{
    m_List = value;
    m_ListIsSet = true;
}

bool RiskRates::listIsSet() const
{
    return m_ListIsSet;
}

void RiskRates::unsetList()
{
    m_ListIsSet = false;
}
int32_t RiskRates::getTotal() const
{
    return m_Total;
}

void RiskRates::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool RiskRates::totalIsSet() const
{
    return m_TotalIsSet;
}

void RiskRates::unsetTotal()
{
    m_TotalIsSet = false;
}
}
