...
Commandws_req_DeleteLimitOrder::Commandws_req_DeleteLimitOrder()
{
...
void Commandws_req_DeleteLimitOrder::validate()
{
    // TODO: implement validation
}

web::json::value Commandws_req_DeleteLimitOrder::toJson() const
{
...
bool Commandws_req_DeleteLimitOrder::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Commandws_req_DeleteLimitOrder::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Commandws_req_DeleteLimitOrder::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Commandws_req_DeleteLimitOrder::getOpcode() const
{
    return m_Opcode;
}

void Commandws_req_DeleteLimitOrder::setOpcode(const utility::string_t& value)
{
    m_Opcode = value;
    m_OpcodeIsSet = true;
}

bool Commandws_req_DeleteLimitOrder::opcodeIsSet() const
{
    return m_OpcodeIsSet;
}

void Commandws_req_DeleteLimitOrder::unsetOpcode()
{
    m_OpcodeIsSet = false;
}
utility::string_t Commandws_req_DeleteLimitOrder::getGuid() const
{
    return m_Guid;
}

void Commandws_req_DeleteLimitOrder::setGuid(const utility::string_t& value)
{
    m_Guid = value;
    m_GuidIsSet = true;
}

bool Commandws_req_DeleteLimitOrder::guidIsSet() const
{
    return m_GuidIsSet;
}

void Commandws_req_DeleteLimitOrder::unsetGuid()
{
    m_GuidIsSet = false;
}
int64_t Commandws_req_DeleteLimitOrder::getOrderId() const
{
    return m_OrderId;
}

void Commandws_req_DeleteLimitOrder::setOrderId(int64_t value)
{
    m_OrderId = value;
    m_OrderIdIsSet = true;
}

bool Commandws_req_DeleteLimitOrder::orderIdIsSet() const
{
    return m_OrderIdIsSet;
}

void Commandws_req_DeleteLimitOrder::unsetOrderId()
{
    m_OrderIdIsSet = false;
}
std::shared_ptr<Exchange> Commandws_req_DeleteLimitOrder::getExchange() const
{
    return m_Exchange;
}

void Commandws_req_DeleteLimitOrder::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Commandws_req_DeleteLimitOrder::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Commandws_req_DeleteLimitOrder::unsetExchange()
{
    m_ExchangeIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user> Commandws_req_DeleteLimitOrder::getUser() const
{
    return m_User;
}

void Commandws_req_DeleteLimitOrder::setUser(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_user>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Commandws_req_DeleteLimitOrder::userIsSet() const
{
    return m_UserIsSet;
}

void Commandws_req_DeleteLimitOrder::unsetUser()
{
    m_UserIsSet = false;
}
bool Commandws_req_DeleteLimitOrder::isCheckDuplicates() const
{
    return m_CheckDuplicates;
}

void Commandws_req_DeleteLimitOrder::setCheckDuplicates(bool value)
{
    m_CheckDuplicates = value;
    m_CheckDuplicatesIsSet = true;
}

bool Commandws_req_DeleteLimitOrder::checkDuplicatesIsSet() const
{
    return m_CheckDuplicatesIsSet;
}

void Commandws_req_DeleteLimitOrder::unsetCheckDuplicates()
{
    m_CheckDuplicatesIsSet = false;
}
}
