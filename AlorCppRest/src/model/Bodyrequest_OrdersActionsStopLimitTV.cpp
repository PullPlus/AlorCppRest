...
#include "AlorCppRest/model/Bodyrequest_OrdersActionsStopLimitTV.h"

namespace alormodel {



Bodyrequest_OrdersActionsStopLimitTV::Bodyrequest_OrdersActionsStopLimitTV()
{
...
void Bodyrequest_OrdersActionsStopLimitTV::validate()
{
    // TODO: implement validation
}

web::json::value Bodyrequest_OrdersActionsStopLimitTV::toJson() const
{
...
bool Bodyrequest_OrdersActionsStopLimitTV::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Bodyrequest_OrdersActionsStopLimitTV::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bodyrequest_OrdersActionsStopLimitTV::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Bodyrequest_OrdersActionsStopLimitTV::getSymbol() const
{
    return m_Symbol;
}

void Bodyrequest_OrdersActionsStopLimitTV::setSymbol(const utility::string_t& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool Bodyrequest_OrdersActionsStopLimitTV::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void Bodyrequest_OrdersActionsStopLimitTV::unsetSymbol()
{
    m_SymbolIsSet = false;
}
std::shared_ptr<Side> Bodyrequest_OrdersActionsStopLimitTV::getSide() const
{
    return m_Side;
}

void Bodyrequest_OrdersActionsStopLimitTV::setSide(const std::shared_ptr<Side>& value)
{
    m_Side = value;
    m_SideIsSet = true;
}

bool Bodyrequest_OrdersActionsStopLimitTV::sideIsSet() const
{
    return m_SideIsSet;
}

void Bodyrequest_OrdersActionsStopLimitTV::unsetSide()
{
    m_SideIsSet = false;
}
double Bodyrequest_OrdersActionsStopLimitTV::getPrice() const
{
    return m_Price;
}

void Bodyrequest_OrdersActionsStopLimitTV::setPrice(double value)
{
    m_Price = value;
    m_PriceIsSet = true;
}

bool Bodyrequest_OrdersActionsStopLimitTV::priceIsSet() const
{
    return m_PriceIsSet;
}

void Bodyrequest_OrdersActionsStopLimitTV::unsetPrice()
{
    m_PriceIsSet = false;
}
utility::string_t Bodyrequest_OrdersActionsStopLimitTV::getType() const
{
    return m_Type;
}

void Bodyrequest_OrdersActionsStopLimitTV::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool Bodyrequest_OrdersActionsStopLimitTV::typeIsSet() const
{
    return m_TypeIsSet;
}

void Bodyrequest_OrdersActionsStopLimitTV::unsetType()
{
    m_TypeIsSet = false;
}
double Bodyrequest_OrdersActionsStopLimitTV::getTakeProfit() const
{
    return m_TakeProfit;
}

void Bodyrequest_OrdersActionsStopLimitTV::setTakeProfit(double value)
{
    m_TakeProfit = value;
    m_TakeProfitIsSet = true;
}

bool Bodyrequest_OrdersActionsStopLimitTV::takeProfitIsSet() const
{
    return m_TakeProfitIsSet;
}

void Bodyrequest_OrdersActionsStopLimitTV::unsetTakeProfit()
{
    m_TakeProfitIsSet = false;
}
double Bodyrequest_OrdersActionsStopLimitTV::getTriggerPrice() const
{
    return m_TriggerPrice;
}

void Bodyrequest_OrdersActionsStopLimitTV::setTriggerPrice(double value)
{
    m_TriggerPrice = value;
    m_TriggerPriceIsSet = true;
}

bool Bodyrequest_OrdersActionsStopLimitTV::triggerPriceIsSet() const
{
    return m_TriggerPriceIsSet;
}

void Bodyrequest_OrdersActionsStopLimitTV::unsetTriggerPrice()
{
    m_TriggerPriceIsSet = false;
}
int32_t Bodyrequest_OrdersActionsStopLimitTV::getQuantity() const
{
    return m_Quantity;
}

void Bodyrequest_OrdersActionsStopLimitTV::setQuantity(int32_t value)
{
    m_Quantity = value;
    m_QuantityIsSet = true;
}

bool Bodyrequest_OrdersActionsStopLimitTV::quantityIsSet() const
{
    return m_QuantityIsSet;
}

void Bodyrequest_OrdersActionsStopLimitTV::unsetQuantity()
{
    m_QuantityIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument> Bodyrequest_OrdersActionsStopLimitTV::getInstrument() const
{
    return m_Instrument;
}

void Bodyrequest_OrdersActionsStopLimitTV::setInstrument(const std::shared_ptr<Bodyrequest_OrdersActionsLimitTVput_instrument>& value)
{
    m_Instrument = value;
    m_InstrumentIsSet = true;
}

bool Bodyrequest_OrdersActionsStopLimitTV::instrumentIsSet() const
{
    return m_InstrumentIsSet;
}

void Bodyrequest_OrdersActionsStopLimitTV::unsetInstrument()
{
    m_InstrumentIsSet = false;
}
std::shared_ptr<Bodyrequest_OrdersActionsMarketTVput_user> Bodyrequest_OrdersActionsStopLimitTV::getUser() const
{
    return m_User;
}

void Bodyrequest_OrdersActionsStopLimitTV::setUser(const std::shared_ptr<Bodyrequest_OrdersActionsMarketTVput_user>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Bodyrequest_OrdersActionsStopLimitTV::userIsSet() const
{
    return m_UserIsSet;
}

void Bodyrequest_OrdersActionsStopLimitTV::unsetUser()
{
    m_UserIsSet = false;
}
utility::datetime Bodyrequest_OrdersActionsStopLimitTV::getEndTime() const
{
    return m_EndTime;
}

void Bodyrequest_OrdersActionsStopLimitTV::setEndTime(const utility::datetime& value)
{
    m_EndTime = value;
    m_EndTimeIsSet = true;
}

bool Bodyrequest_OrdersActionsStopLimitTV::endTimeIsSet() const
{
    return m_EndTimeIsSet;
}

void Bodyrequest_OrdersActionsStopLimitTV::unsetEndTime()
{
    m_EndTimeIsSet = false;
}
int64_t Bodyrequest_OrdersActionsStopLimitTV::getStopEndUnixTime() const
{
    return m_StopEndUnixTime;
}

void Bodyrequest_OrdersActionsStopLimitTV::setStopEndUnixTime(int64_t value)
{
    m_StopEndUnixTime = value;
    m_StopEndUnixTimeIsSet = true;
}

bool Bodyrequest_OrdersActionsStopLimitTV::stopEndUnixTimeIsSet() const
{
    return m_StopEndUnixTimeIsSet;
}

void Bodyrequest_OrdersActionsStopLimitTV::unsetStopEndUnixTime()
{
    m_StopEndUnixTimeIsSet = false;
}
}
