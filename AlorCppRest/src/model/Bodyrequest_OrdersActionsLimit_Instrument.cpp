...
Bodyrequest_OrdersActionsLimit_Instrument::Bodyrequest_OrdersActionsLimit_Instrument()
{
...
void Bodyrequest_OrdersActionsLimit_Instrument::validate()
{
    // TODO: implement validation
}

web::json::value Bodyrequest_OrdersActionsLimit_Instrument::toJson() const
{
...
bool Bodyrequest_OrdersActionsLimit_Instrument::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Bodyrequest_OrdersActionsLimit_Instrument::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bodyrequest_OrdersActionsLimit_Instrument::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Bodyrequest_OrdersActionsLimit_Instrument::getSymbol() const
{
    return m_Symbol;
}

void Bodyrequest_OrdersActionsLimit_Instrument::setSymbol(const utility::string_t& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool Bodyrequest_OrdersActionsLimit_Instrument::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void Bodyrequest_OrdersActionsLimit_Instrument::unsetSymbol()
{
    m_SymbolIsSet = false;
}
std::shared_ptr<Exchange> Bodyrequest_OrdersActionsLimit_Instrument::getExchange() const
{
    return m_Exchange;
}

void Bodyrequest_OrdersActionsLimit_Instrument::setExchange(const std::shared_ptr<Exchange>& value)
{
    m_Exchange = value;
    m_ExchangeIsSet = true;
}

bool Bodyrequest_OrdersActionsLimit_Instrument::exchangeIsSet() const
{
    return m_ExchangeIsSet;
}

void Bodyrequest_OrdersActionsLimit_Instrument::unsetExchange()
{
    m_ExchangeIsSet = false;
}
}
