...
#include "AlorCppRest/model/Bodyrequest_CreateOrderGroup.h"

namespace alormodel {



Bodyrequest_CreateOrderGroup::Bodyrequest_CreateOrderGroup()
{
    m_OrdersIsSet = false;
...
void Bodyrequest_CreateOrderGroup::validate()
{
    // TODO: implement validation
}

web::json::value Bodyrequest_CreateOrderGroup::toJson() const
{
...
bool Bodyrequest_CreateOrderGroup::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("Orders"))))
    {
        ...
        {
            std::vector<std::shared_ptr<OrderGroupItem>> refVal_setOrders;
...
void Bodyrequest_CreateOrderGroup::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bodyrequest_CreateOrderGroup::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<OrderGroupItem>>& Bodyrequest_CreateOrderGroup::getOrders()
{
    return m_Orders;
}

void Bodyrequest_CreateOrderGroup::setOrders(const std::vector<std::shared_ptr<OrderGroupItem>>& value)
{
    m_Orders = value;
    m_OrdersIsSet = true;
}

bool Bodyrequest_CreateOrderGroup::ordersIsSet() const
{
    return m_OrdersIsSet;
}

void Bodyrequest_CreateOrderGroup::unsetOrders()
{
    m_OrdersIsSet = false;
}
std::shared_ptr<ExecutionPolicy> Bodyrequest_CreateOrderGroup::getExecutionPolicy() const
{
    return m_ExecutionPolicy;
}

void Bodyrequest_CreateOrderGroup::setExecutionPolicy(const std::shared_ptr<ExecutionPolicy>& value)
{
    m_ExecutionPolicy = value;
    m_ExecutionPolicyIsSet = true;
}

bool Bodyrequest_CreateOrderGroup::executionPolicyIsSet() const
{
    return m_ExecutionPolicyIsSet;
}

void Bodyrequest_CreateOrderGroup::unsetExecutionPolicy()
{
    m_ExecutionPolicyIsSet = false;
}
}
