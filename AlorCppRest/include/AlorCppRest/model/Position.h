...
#ifndef ALORMODEL_Position_H_
#define ALORMODEL_Position_H_
...
public:
    ...
    /// </summary>
    double getOpenQtyBatch() const;
    bool openQtyBatchIsSet() const;
    void unsetOpenQtyBatch();

    void setOpenQtyBatch(double value);
