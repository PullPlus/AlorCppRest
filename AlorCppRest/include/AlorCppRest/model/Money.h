...
#ifndef ALORMODEL_Money_H_
#define ALORMODEL_Money_H_
...
public:
    ...
    /// Изменения
    /// </summary>
    double getChanges() const;
    bool changesIsSet() const;
    void unsetChanges();

    void setChanges(double value);
    ...
    void setPortfolio(double value);
