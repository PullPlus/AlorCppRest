...
#ifndef ALORMODEL_Alltrade_H_
#define ALORMODEL_Alltrade_H_
...
public:
    ...
    /// </summary>
    int64_t getOrderno() const;
    bool ordernoIsSet() const;
    void unsetOrderno();

    void setOrderno(int64_t value);
