...
/*
 * Ws_req_OrdersGetAndSubscribe.h
 *
 * 
 */

#ifndef ALORMODEL_Ws_req_OrdersGetAndSubscribe_H_
#define ALORMODEL_Ws_req_OrdersGetAndSubscribe_H_
...
/// 
/// </summary>
class  Ws_req_OrdersGetAndSubscribe
    : public ModelBase
{
public:
    Ws_req_OrdersGetAndSubscribe();
    virtual ~Ws_req_OrdersGetAndSubscribe();
    ...
    /////////////////////////////////////////////
    /// Ws_req_OrdersGetAndSubscribe members
    ...
    /// </summary>
    std::vector<std::shared_ptr<OrderStatus>>& getOrderStatuses();
    bool orderStatusesIsSet() const;
    void unsetOrderStatuses();

    void setOrderStatuses(const std::vector<std::shared_ptr<OrderStatus>>& value);
...
protected:
    ...
    bool m_GuidIsSet;
    std::vector<std::shared_ptr<OrderStatus>> m_OrderStatuses;
    bool m_OrderStatusesIsSet;
};


}

#endif /* ALORMODEL_Ws_req_OrdersGetAndSubscribe_H_ */
