...
#ifndef ALORMODEL_StoporderWarp_H_
#define ALORMODEL_StoporderWarp_H_
...
public:
    ...
    /// Уникальный идентификатор стоп-заявки
    /// </summary>
    int64_t getExchangeOrderId() const;
    bool exchangeOrderIdIsSet() const;
    void unsetExchangeOrderId();

    void setExchangeOrderId(int64_t value);
...
#endif /* ALORMODEL_StoporderWarp_H_ */
